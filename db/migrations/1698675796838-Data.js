module.exports = class Data1698675796838 {
    name = 'Data1698675796838'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "round_collator" ("id" character varying NOT NULL, "own_bond" numeric, "total_bond" numeric NOT NULL, "reward_amount" numeric, "apr" numeric, "apr_techn_numerator" numeric, "apr_techn_denominator" numeric, "nominators_count" integer, "staker_id" character varying NOT NULL, "round_id" character varying, "collator_id" character varying, CONSTRAINT "PK_32b73164cfc62741feb236d9895" PRIMARY KEY ("id"))`)
