...
export class SocietyElevatedEvent {
    private readonly _chain: Chain
    private readonly event: Event
    ...
    constructor(ctx: EventContext, event?: Event) {
        event = event || ctx.event
        assert(event.name === 'Society.Elevated')
        this._chain = ctx._chain
        this.event = event
    }
    ...
    get isV1000000(): boolean {
        return this._chain.getEventHash('Society.Elevated') === '1d670fd0805c9ff974febe86a8edea80ad6350f057c759a59c1b2c5fd410a21d'
    }

    /**
     * A \[member\] got elevated to \[rank\].
     */
    get asV1000000(): {member: Uint8Array, rank: number} {
...
export class SocietyNewParamsEvent {
    private readonly _chain: Chain
    private readonly event: Event
    ...
    constructor(ctx: EventContext, event?: Event) {
        event = event || ctx.event
        assert(event.name === 'Society.NewParams')
        this._chain = ctx._chain
        this.event = event
    }
     ...
     */
    get isV1000000(): boolean {
        return this._chain.getEventHash('Society.NewParams') === '2142c13640672de893fe586f336667da30ec4aa687c5e59961d88da0ece6d9c6'
    }

    /**
     * A new set of \[params\] has been set for the group.
     */
    get asV1000000(): {params: v1000000.GroupParams} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StateTrieMigrationHaltedEvent {
     ...
     * Migration got halted due to an error or miss-configuration.
     */
    get asV1000000(): {error: v1000000.Error} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StateTrieMigrationMigratedEvent {
     ...
     * `compute`.
     */
    get asV1000000(): {top: number, child: number, compute: v1000000.MigrationCompute} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class StateTrieMigrationSlashedEvent {
     ...
     * Some account got slashed by the given amount.
     */
    get asV1000000(): {who: Uint8Array, amount: bigint} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletAssetsClaimedEvent {
     ...
     * Some assets have been claimed from an asset trap
     */
    get asV1000000(): {hash: Uint8Array, origin: v1000000.V3MultiLocation, assets: v1000000.VersionedMultiAssets} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletAttemptedEvent {
     ...
     * Execution of an XCM message was attempted.
     */
    get asV1000000(): {outcome: v1000000.V3Outcome} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletFeesPaidEvent {
     ...
     * Fees were paid from a location for an operation (often for using `SendXcm`).
     */
    get asV1000000(): {paying: v1000000.V3MultiLocation, fees: v1000000.V3MultiAsset[]} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletInvalidQuerierEvent {
     ...
     * be received and acted upon.
     */
    get asV1000000(): {origin: v1000000.V3MultiLocation, queryId: bigint, expectedQuerier: v1000000.V3MultiLocation, maybeActualQuerier: (v1000000.V3MultiLocation | undefined)} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletInvalidQuerierVersionEvent {
     ...
     * needed.
     */
    get asV1000000(): {origin: v1000000.V3MultiLocation, queryId: bigint} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletInvalidResponderEvent {
     ...
     * be received and acted upon.
     */
    get asV1000000(): {origin: v1000000.V3MultiLocation, queryId: bigint, expectedLocation: (v1000000.V3MultiLocation | undefined)} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletNotifiedEvent {
     ...
     * been dispatched and executed successfully.
     */
    get asV1000000(): {queryId: bigint, palletIndex: number, callIndex: number} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletNotifyOverweightEvent {
     ...
     * originally budgeted by this runtime for the query result.
     */
    get asV1000000(): {queryId: bigint, palletIndex: number, callIndex: number, actualWeight: v1000000.Weight, maxBudgetedWeight: v1000000.Weight} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletNotifyTargetMigrationFailEvent {
     ...
     * migrating the location to our new XCM format.
     */
    get asV1000000(): {location: v1000000.VersionedMultiLocation, queryId: bigint} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletNotifyTargetSendFailEvent {
     ...
     * sending the notification to it.
     */
    get asV1000000(): {location: v1000000.V3MultiLocation, queryId: bigint, error: v1000000.V3Error} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletResponseReadyEvent {
     ...
     * no registered notification call.
     */
    get asV1000000(): {queryId: bigint, response: v1000000.V3Response} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletSentEvent {
     ...
     * A XCM message was sent.
     */
    get asV1000000(): {origin: v1000000.V3MultiLocation, destination: v1000000.V3MultiLocation, message: v1000000.V3Instruction[], messageId: Uint8Array} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletSupportedVersionChangedEvent {
     ...
     * automatic notification or a manual intervention.
     */
    get asV1000000(): {location: v1000000.V3MultiLocation, version: number} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletVersionChangeNotifiedEvent {
     ...
     * The cost of sending it (borne by the chain) is included.
     */
    get asV1000000(): {destination: v1000000.V3MultiLocation, result: number, cost: v1000000.V3MultiAsset[], messageId: Uint8Array} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XcmPalletVersionNotifyRequestedEvent {
     ...
     * We have requested that a remote chain send us XCM version change notifications.
     */
    get asV1000000(): {destination: v1000000.V3MultiLocation, cost: v1000000.V3MultiAsset[], messageId: Uint8Array} {
        assert(this.isV1000000)
        return this._chain.decodeEvent(this.event)
    }
}
