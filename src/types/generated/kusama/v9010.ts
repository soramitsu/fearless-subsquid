...
export const TrieIndex = sts.number()
...
export type WinningData = WinningDataEntry[]

export type WinningDataEntry = ([AccountId, ParaId, BalanceOf] | undefined)

export const WinningData = sts.array(() => WinningDataEntry)

export const WinningDataEntry = sts.option(() => sts.tuple(() => [AccountId, ParaId, BalanceOf]))
...
export type AuthorityDiscoveryId = Bytes

export const SessionInfo: sts.Type<SessionInfo> = sts.struct(() => {
    return  {
        validators: sts.array(() => ValidatorId),
        discoveryKeys: sts.array(() => AuthorityDiscoveryId),
        assignmentKeys: sts.array(() => AssignmentId),
        validatorGroups: sts.array(() => sts.array(() => ParaValidatorIndex)),
        nCores: sts.number(),
...
export const AuthorityDiscoveryId = sts.bytes()

export type AssignmentId = Bytes

export const AssignmentId = sts.bytes()
...
export const ParaGenesisArgs: sts.Type<ParaGenesisArgs> = sts.struct(() => {
    return  {
        genesisHead: sts.bytes(),
        validationCode: sts.bytes(),
        parachain: sts.boolean(),
    }
})

export interface ParaPastCodeMeta {
    upgradeTimes: ReplacementTimes[]
    lastPruned?: (BlockNumber | undefined)
}
...
export const ParaPastCodeMeta: sts.Type<ParaPastCodeMeta> = sts.struct(() => {
    return  {
        ...
        lastPruned: sts.option(() => BlockNumber),
    }
})
...
export type ParaLifecycle = ParaLifecycle_DowngradingToParathread | ParaLifecycle_Onboarding | ParaLifecycle_OutgoingParachain | ParaLifecycle_OutgoingParathread | ParaLifecycle_Parachain | ParaLifecycle_Parathread | ParaLifecycle_UpgradingToParachain
...
export const ParaLifecycle: sts.Type<ParaLifecycle> = sts.closedEnum(() => {
    return  {
        DowngradingToParathread: sts.unit(),
        Onboarding: sts.unit(),
        OutgoingParachain: sts.unit(),
        OutgoingParathread: sts.unit(),
        Parachain: sts.unit(),
        Parathread: sts.unit(),
        UpgradingToParachain: sts.unit(),
    }
})
...
export const AssignmentKind: sts.Type<AssignmentKind> = sts.closedEnum(() => {
    return  {
        Parachain: sts.unit(),
        Parathread: sts.tuple(() => [CollatorId, sts.number()]),
    }
})

export const CollatorId = sts.bytes()

export type CoreOccupied = CoreOccupied_Parachain | CoreOccupied_Parathread
...
export type ParathreadClaim = [ParaId, CollatorId]
...
export const ParathreadEntry: sts.Type<ParathreadEntry> = sts.struct(() => {
    return  {
        claim: ParathreadClaim,
        retries: sts.number(),
    }
...
export const ParathreadClaim = sts.tuple(() => [ParaId, CollatorId])
...
export const AvailabilityBitfield = sts.bitseq()
...
export const HostConfiguration: sts.Type<HostConfiguration> = sts.struct(() => {
    return  {
        ...
        disputePeriod: SessionIndex,
        disputePostConclusionAcceptancePeriod: BlockNumber,
        disputeMaxSpamSlots: sts.number(),
        disputeConclusionByTimeOutPeriod: BlockNumber,
        noShowSlots: sts.number(),
        nDelayTranches: sts.number(),
        zerothDelayTrancheWidth: sts.number(),
...
export const ActiveGilt: sts.Type<ActiveGilt> = sts.struct(() => {
    return  {
        proportion: Perquintill,
        amount: Balance,
        who: AccountId,
...
export const ActiveGiltsTotal: sts.Type<ActiveGiltsTotal> = sts.struct(() => {
    return  {
        frozen: Balance,
        proportion: Perquintill,
        index: ActiveIndex,
...
export const GiltBid: sts.Type<GiltBid> = sts.struct(() => {
    return  {
        amount: Balance,
        who: AccountId,
    }
...
export type PalletsOrigin = PalletsOrigin_Council | PalletsOrigin_System | PalletsOrigin_TechnicalCommittee | PalletsOrigin_XcmPallet
...
export const XcmOrigin: sts.Type<XcmOrigin> = sts.closedEnum(() => {
    return  {
        Xcm: MultiLocation,
    }
})
...
export type Type_491 = Type_491_Auctions | Type_491_Balances | Type_491_Bounties | Type_491_Claims | Type_491_Council | Type_491_Crowdloan | Type_491_Democracy | Type_491_ElectionProviderMultiPhase | Type_491_Gilt | Type_491_Grandpa | Type_491_Identity | Type_491_ImOnline | Type_491_Indices | Type_491_Multisig | Type_491_Offences | Type_491_Paras | Type_491_ParasHrmp | Type_491_ParasInclusion | Type_491_PhragmenElection | Type_491_Proxy | Type_491_Recovery | Type_491_Registrar | Type_491_Scheduler | Type_491_Session | Type_491_Slots | Type_491_Society | Type_491_Staking | Type_491_System | Type_491_TechnicalCommittee | Type_491_TechnicalMembership | Type_491_Tips | Type_491_Treasury | Type_491_Utility | Type_491_Vesting | Type_491_XcmPallet

export interface Type_491_Auctions {
    __kind: 'Auctions'
    value: AuctionsEvent
}

export interface Type_491_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_491_Bounties {
    __kind: 'Bounties'
    value: BountiesEvent
}

export interface Type_491_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_491_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_491_Crowdloan {
    __kind: 'Crowdloan'
    value: CrowdloanEvent
}

export interface Type_491_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_491_ElectionProviderMultiPhase {
    __kind: 'ElectionProviderMultiPhase'
    value: ElectionProviderMultiPhaseEvent
}

export interface Type_491_Gilt {
    __kind: 'Gilt'
    value: GiltEvent
}

export interface Type_491_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_491_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_491_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_491_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_491_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_491_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_491_Paras {
    __kind: 'Paras'
    value: ParasEvent
}

export interface Type_491_ParasHrmp {
    __kind: 'ParasHrmp'
    value: ParasHrmpEvent
}

export interface Type_491_ParasInclusion {
    __kind: 'ParasInclusion'
    value: ParasInclusionEvent
}

export interface Type_491_PhragmenElection {
    __kind: 'PhragmenElection'
    value: PhragmenElectionEvent
}

export interface Type_491_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_491_Recovery {
    __kind: 'Recovery'
    value: RecoveryEvent
}

export interface Type_491_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_491_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_491_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_491_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_491_Society {
    __kind: 'Society'
    value: SocietyEvent
}

export interface Type_491_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_491_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_491_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_491_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_491_Tips {
    __kind: 'Tips'
    value: TipsEvent
}

export interface Type_491_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_491_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_491_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}

export interface Type_491_XcmPallet {
    __kind: 'XcmPallet'
...
export interface SlotsEvent_Leased {
    __kind: 'Leased'
    value: [ParaId, AccountId, LeasePeriod, LeasePeriod, Balance, Balance]
}
...
export interface ParasInclusionEvent_CandidateBacked {
    ...
    value: [CandidateReceipt, HeadData, CoreIndex, GroupIndex]
}
...
export interface ParasInclusionEvent_CandidateTimedOut {
    ...
    value: [CandidateReceipt, HeadData, CoreIndex]
}
...
export type ParasHrmpEvent = ParasHrmpEvent_ChannelClosed | ParasHrmpEvent_OpenChannelAccepted | ParasHrmpEvent_OpenChannelRequested
...
export interface ParasHrmpEvent_OpenChannelRequested {
    ...
    value: [ParaId, ParaId, number, number]
}
...
export interface GiltEvent_BidPlaced {
    __kind: 'BidPlaced'
    value: [AccountId, BalanceOf, number]
}
...
export interface GiltEvent_GiltIssued {
    __kind: 'GiltIssued'
    value: [ActiveIndex, BlockNumber, AccountId, BalanceOf]
}
...
export interface GiltEvent_GiltThawed {
    __kind: 'GiltThawed'
    value: [ActiveIndex, AccountId, BalanceOf, BalanceOf]
}
...
export type CrowdloanEvent = CrowdloanEvent_AddedToNewRaise | CrowdloanEvent_AllRefunded | CrowdloanEvent_Contributed | CrowdloanEvent_Created | CrowdloanEvent_DeployDataFixed | CrowdloanEvent_Dissolved | CrowdloanEvent_Edited | CrowdloanEvent_HandleBidResult | CrowdloanEvent_MemoUpdated | CrowdloanEvent_Onboarded | CrowdloanEvent_PartiallyRefunded | CrowdloanEvent_Withdrew
...
export interface CrowdloanEvent_Contributed {
    __kind: 'Contributed'
    value: [AccountId, ParaId, Balance]
}
...
export type AuctionsEvent = AuctionsEvent_AuctionClosed | AuctionsEvent_AuctionStarted | AuctionsEvent_BidAccepted | AuctionsEvent_ReserveConfiscated | AuctionsEvent_Reserved | AuctionsEvent_Unreserved | AuctionsEvent_WinningOffset | AuctionsEvent_WonDeploy | AuctionsEvent_WonRenewal
...
export interface AuctionsEvent_BidAccepted {
    __kind: 'BidAccepted'
    value: [AccountId, ParaId, Balance, LeasePeriod, LeasePeriod]
}
...
export interface AuctionsEvent_ReserveConfiscated {
    ...
    value: [ParaId, AccountId, Balance]
}
...
export interface AuctionsEvent_WinningOffset {
    ...
    value: [AuctionIndex, BlockNumber]
}
...
export interface AuctionsEvent_WonDeploy {
    __kind: 'WonDeploy'
    value: [AccountId, SlotRange, ParaId, Balance]
}
...
export interface AuctionsEvent_WonRenewal {
    __kind: 'WonRenewal'
    value: [ParaId, LeasePeriod, LeasePeriod, Balance]
}
...
export const Type_491: sts.Type<Type_491> = sts.closedEnum(() => {
    return  {
        ...
        Paras: ParasEvent,
        ParasHrmp: ParasHrmpEvent,
        ParasInclusion: ParasInclusionEvent,
...
export const XcmPalletEvent: sts.Type<XcmPalletEvent> = sts.closedEnum(() => {
    return  {
        Attempted: Outcome,
        Sent: sts.tuple(() => [MultiLocation, MultiLocation, Xcm]),
    }
})
...
export const SlotsEvent: sts.Type<SlotsEvent> = sts.closedEnum(() => {
    return  {
        Leased: sts.tuple(() => [ParaId, AccountId, LeasePeriod, LeasePeriod, Balance, Balance]),
...
export const RegistrarEvent: sts.Type<RegistrarEvent> = sts.closedEnum(() => {
    return  {
        Deregistered: ParaId,
        Registered: sts.tuple(() => [ParaId, AccountId]),
        Reserved: sts.tuple(() => [ParaId, AccountId]),
    }
})
...
export const ParasInclusionEvent: sts.Type<ParasInclusionEvent> = sts.closedEnum(() => {
    return  {
        CandidateBacked: sts.tuple(() => [CandidateReceipt, HeadData, CoreIndex, GroupIndex]),
        CandidateIncluded: sts.tuple(() => [CandidateReceipt, HeadData, CoreIndex, GroupIndex]),
        CandidateTimedOut: sts.tuple(() => [CandidateReceipt, HeadData, CoreIndex]),
    }
})

export const ParasHrmpEvent: sts.Type<ParasHrmpEvent> = sts.closedEnum(() => {
    return  {
        ChannelClosed: sts.tuple(() => [ParaId, HrmpChannelId]),
        OpenChannelAccepted: sts.tuple(() => [ParaId, ParaId]),
        OpenChannelRequested: sts.tuple(() => [ParaId, ParaId, sts.number(), sts.number()]),
    }
})

export const ParasEvent: sts.Type<ParasEvent> = sts.closedEnum(() => {
    return  {
        ActionQueued: sts.tuple(() => [ParaId, SessionIndex]),
...
export const GiltEvent: sts.Type<GiltEvent> = sts.closedEnum(() => {
    return  {
        BidPlaced: sts.tuple(() => [AccountId, BalanceOf, sts.number()]),
        BidRetracted: sts.tuple(() => [AccountId, BalanceOf, sts.number()]),
        GiltIssued: sts.tuple(() => [ActiveIndex, BlockNumber, AccountId, BalanceOf]),
        GiltThawed: sts.tuple(() => [ActiveIndex, AccountId, BalanceOf, BalanceOf]),
    }
})
...
export const CrowdloanEvent: sts.Type<CrowdloanEvent> = sts.closedEnum(() => {
    return  {
        ...
        AllRefunded: ParaId,
        Contributed: sts.tuple(() => [AccountId, ParaId, Balance]),
        Created: ParaId,
        DeployDataFixed: ParaId,
        Dissolved: ParaId,
        Edited: ParaId,
        HandleBidResult: sts.tuple(() => [ParaId, DispatchResult]),
        MemoUpdated: sts.tuple(() => [AccountId, ParaId, sts.bytes()]),
        Onboarded: sts.tuple(() => [ParaId, ParaId]),
        PartiallyRefunded: ParaId,
        Withdrew: sts.tuple(() => [AccountId, ParaId, Balance]),
    }
})
...
export const AuctionsEvent: sts.Type<AuctionsEvent> = sts.closedEnum(() => {
    return  {
        ...
        BidAccepted: sts.tuple(() => [AccountId, ParaId, Balance, LeasePeriod, LeasePeriod]),
        ReserveConfiscated: sts.tuple(() => [ParaId, AccountId, Balance]),
        Reserved: sts.tuple(() => [AccountId, Balance, Balance]),
        Unreserved: sts.tuple(() => [AccountId, Balance]),
        WinningOffset: sts.tuple(() => [AuctionIndex, BlockNumber]),
        WonDeploy: sts.tuple(() => [AccountId, SlotRange, ParaId, Balance]),
        WonRenewal: sts.tuple(() => [ParaId, LeasePeriod, LeasePeriod, Balance]),
    }
})
