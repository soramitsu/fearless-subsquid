...
export interface PendingSlashes {
    keys: [V4ValidatorIndex, V4Public][]
...
export const PendingSlashes: sts.Type<PendingSlashes> = sts.struct(() => {
    return  {
        keys: sts.array(() => sts.tuple(() => [V4ValidatorIndex, V4Public])),
        kind: SlashingOffenceKind,
    }
})
...
export type Type_632 = Type_632_Approved | Type_632_Cancelled | Type_632_Killed | Type_632_Ongoing | Type_632_Rejected | Type_632_TimedOut
...
export const Type_632: sts.Type<Type_632> = sts.closedEnum(() => {
    return  {
...
export const Type_633: sts.Type<Type_633> = sts.struct(() => {
    return  {
        track: sts.number(),
        origin: OriginCaller,
        proposal: Bounded,
...
export type Event = Event_Auctions | Event_Balances | Event_Bounties | Event_ChildBounties | Event_Claims | Event_ConvictionVoting | Event_Crowdloan | Event_ElectionProviderMultiPhase | Event_FastUnstake | Event_FellowshipCollective | Event_FellowshipReferenda | Event_Grandpa | Event_Hrmp | Event_Identity | Event_ImOnline | Event_Indices | Event_Multisig | Event_Nis | Event_NisCounterpartBalances | Event_NominationPools | Event_Offences | Event_ParaInclusion | Event_Paras | Event_ParasDisputes | Event_Preimage | Event_Proxy | Event_Recovery | Event_Referenda | Event_Registrar | Event_Scheduler | Event_Session | Event_Slots | Event_Society | Event_Staking | Event_System | Event_TransactionPayment | Event_Treasury | Event_Ump | Event_Utility | Event_Vesting | Event_VoterList | Event_Whitelist | Event_XcmPallet
 ...
 */
export type SocietyEvent = SocietyEvent_AutoUnbid | SocietyEvent_Bid | SocietyEvent_CandidateSuspended | SocietyEvent_Challenged | SocietyEvent_DefenderVote | SocietyEvent_Deposit | SocietyEvent_Founded | SocietyEvent_Inducted | SocietyEvent_MemberSuspended | SocietyEvent_NewMaxMembers | SocietyEvent_SkepticsChosen | SocietyEvent_SuspendedMemberJudgement | SocietyEvent_Unbid | SocietyEvent_Unfounded | SocietyEvent_Unvouch | SocietyEvent_Vote | SocietyEvent_Vouch
