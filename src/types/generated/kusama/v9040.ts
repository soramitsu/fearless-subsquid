...
export type Type_494 = Type_494_Auctions | Type_494_Balances | Type_494_Bounties | Type_494_Claims | Type_494_Council | Type_494_Crowdloan | Type_494_Democracy | Type_494_ElectionProviderMultiPhase | Type_494_Gilt | Type_494_Grandpa | Type_494_Identity | Type_494_ImOnline | Type_494_Indices | Type_494_Multisig | Type_494_Offences | Type_494_Paras | Type_494_ParasHrmp | Type_494_ParasInclusion | Type_494_ParasUmp | Type_494_PhragmenElection | Type_494_Proxy | Type_494_Recovery | Type_494_Registrar | Type_494_Scheduler | Type_494_Session | Type_494_Slots | Type_494_Society | Type_494_Staking | Type_494_System | Type_494_TechnicalCommittee | Type_494_TechnicalMembership | Type_494_Tips | Type_494_Treasury | Type_494_Utility | Type_494_Vesting | Type_494_XcmPallet

export interface Type_494_Auctions {
    __kind: 'Auctions'
    value: AuctionsEvent
}

export interface Type_494_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_494_Bounties {
    __kind: 'Bounties'
    value: BountiesEvent
}

export interface Type_494_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_494_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_494_Crowdloan {
    __kind: 'Crowdloan'
    value: CrowdloanEvent
}

export interface Type_494_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_494_ElectionProviderMultiPhase {
    __kind: 'ElectionProviderMultiPhase'
    value: ElectionProviderMultiPhaseEvent
}

export interface Type_494_Gilt {
    __kind: 'Gilt'
    value: GiltEvent
}

export interface Type_494_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_494_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_494_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_494_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_494_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_494_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_494_Paras {
    __kind: 'Paras'
    value: ParasEvent
}

export interface Type_494_ParasHrmp {
    __kind: 'ParasHrmp'
    value: ParasHrmpEvent
}

export interface Type_494_ParasInclusion {
    __kind: 'ParasInclusion'
    value: ParasInclusionEvent
}

export interface Type_494_ParasUmp {
    __kind: 'ParasUmp'
    value: ParasUmpEvent
}

export interface Type_494_PhragmenElection {
    __kind: 'PhragmenElection'
    value: PhragmenElectionEvent
}

export interface Type_494_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_494_Recovery {
    __kind: 'Recovery'
    value: RecoveryEvent
}

export interface Type_494_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_494_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_494_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_494_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_494_Society {
    __kind: 'Society'
    value: SocietyEvent
}

export interface Type_494_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_494_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_494_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_494_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_494_Tips {
    __kind: 'Tips'
    value: TipsEvent
}

export interface Type_494_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_494_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_494_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}

export interface Type_494_XcmPallet {
    __kind: 'XcmPallet'
...
export type ParasUmpEvent = ParasUmpEvent_ExecutedUpward | ParasUmpEvent_InvalidFormat | ParasUmpEvent_UnsupportedVersion | ParasUmpEvent_UpwardMessagesReceived | ParasUmpEvent_WeightExhausted
...
export const ParasUmpEvent: sts.Type<ParasUmpEvent> = sts.closedEnum(() => {
    return  {
        ExecutedUpward: sts.tuple(() => [MessageId, Outcome]),
        InvalidFormat: MessageId,
        UnsupportedVersion: MessageId,
        UpwardMessagesReceived: sts.tuple(() => [ParaId, sts.number(), sts.number()]),
        WeightExhausted: sts.tuple(() => [MessageId, Weight, Weight]),
    }
})
