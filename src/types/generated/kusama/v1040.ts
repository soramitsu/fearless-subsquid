...
export const ActiveRecovery: sts.Type<ActiveRecovery> = sts.struct(() => {
    return  {
        created: BlockNumber,
        deposit: Balance,
...
export const RecoveryConfig: sts.Type<RecoveryConfig> = sts.struct(() => {
    return  {
        delayPeriod: BlockNumber,
        deposit: Balance,
        friends: sts.array(() => AccountId),
...
export type SocietyVote = SocietyVote_Approve | SocietyVote_Reject | SocietyVote_Skeptic
...
export const SocietyVote: sts.Type<SocietyVote> = sts.closedEnum(() => {
    return  {
        Approve: sts.unit(),
        Reject: sts.unit(),
        Skeptic: sts.unit(),
...
export type StrikeCount = number

export const StrikeCount = sts.number()
...
export const BidKind: sts.Type<BidKind> = sts.closedEnum(() => {
    return  {
        Deposit: Balance,
        Vouch: sts.tuple(() => [AccountId, Balance]),
    }
})
...
export type SocietyCall = SocietyCall_bid | SocietyCall_defender_vote | SocietyCall_found | SocietyCall_judge_suspended_candidate | SocietyCall_judge_suspended_member | SocietyCall_payout | SocietyCall_set_max_members | SocietyCall_unbid | SocietyCall_unvouch | SocietyCall_vote | SocietyCall_vouch
...
export type RecoveryCall = RecoveryCall_as_recovered | RecoveryCall_claim_recovery | RecoveryCall_close_recovery | RecoveryCall_create_recovery | RecoveryCall_initiate_recovery | RecoveryCall_remove_recovery | RecoveryCall_set_recovered | RecoveryCall_vouch_recovery
...
export type SocietyEvent = SocietyEvent_AutoUnbid | SocietyEvent_Bid | SocietyEvent_CandidateSuspended | SocietyEvent_Challenged | SocietyEvent_DefenderVote | SocietyEvent_Founded | SocietyEvent_Inducted | SocietyEvent_MemberSuspended | SocietyEvent_NewMaxMembers | SocietyEvent_SuspendedMemberJudgement | SocietyEvent_Unbid | SocietyEvent_Unvouch | SocietyEvent_Vote | SocietyEvent_Vouch
