...
export type Proposal = Proposal_Attestations | Proposal_AuthorityDiscovery | Proposal_Authorship | Proposal_Babe | Proposal_Balances | Proposal_Claims | Proposal_Council | Proposal_Democracy | Proposal_ElectionsPhragmen | Proposal_FinalityTracker | Proposal_Grandpa | Proposal_Identity | Proposal_ImOnline | Proposal_Indices | Proposal_Offences | Proposal_Parachains | Proposal_Registrar | Proposal_Session | Proposal_Slots | Proposal_Staking | Proposal_System | Proposal_TechnicalCommittee | Proposal_TechnicalMembership | Proposal_Timestamp | Proposal_Treasury | Proposal_Utility
...
export type Type_110 = Type_110_Attestations | Type_110_AuthorityDiscovery | Type_110_Authorship | Type_110_Babe | Type_110_Balances | Type_110_Claims | Type_110_Council | Type_110_Democracy | Type_110_ElectionsPhragmen | Type_110_FinalityTracker | Type_110_Grandpa | Type_110_Identity | Type_110_ImOnline | Type_110_Indices | Type_110_Offences | Type_110_Parachains | Type_110_Registrar | Type_110_Session | Type_110_Slots | Type_110_Staking | Type_110_System | Type_110_TechnicalCommittee | Type_110_TechnicalMembership | Type_110_Timestamp | Type_110_Treasury | Type_110_Utility
...
export type TechnicalMembershipCall = TechnicalMembershipCall_add_member | TechnicalMembershipCall_change_key | TechnicalMembershipCall_remove_member | TechnicalMembershipCall_reset_members | TechnicalMembershipCall_swap_member
...
export type Type_261 = Type_261_Balances | Type_261_Claims | Type_261_Council | Type_261_Democracy | Type_261_ElectionsPhragmen | Type_261_Grandpa | Type_261_Identity | Type_261_ImOnline | Type_261_Indices | Type_261_Offences | Type_261_Registrar | Type_261_Session | Type_261_Slots | Type_261_Staking | Type_261_System | Type_261_TechnicalCommittee | Type_261_TechnicalMembership | Type_261_Treasury | Type_261_Utility

export interface Type_261_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_261_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_261_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_261_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_261_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_261_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_261_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_261_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_261_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_261_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_261_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_261_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_261_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_261_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_261_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_261_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_261_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_261_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_261_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}
