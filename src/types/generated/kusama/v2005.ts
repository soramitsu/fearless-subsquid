...
export type Type_369 = Type_369_Balances | Type_369_Claims | Type_369_Council | Type_369_Democracy | Type_369_ElectionsPhragmen | Type_369_Grandpa | Type_369_Identity | Type_369_ImOnline | Type_369_Indices | Type_369_Multisig | Type_369_Offences | Type_369_Proxy | Type_369_Recovery | Type_369_Registrar | Type_369_Scheduler | Type_369_Session | Type_369_Slots | Type_369_Society | Type_369_Staking | Type_369_System | Type_369_TechnicalCommittee | Type_369_TechnicalMembership | Type_369_Treasury | Type_369_Utility | Type_369_Vesting

export interface Type_369_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_369_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_369_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_369_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_369_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_369_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_369_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_369_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_369_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_369_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_369_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_369_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_369_Recovery {
    __kind: 'Recovery'
    value: RecoveryEvent
}

export interface Type_369_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_369_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_369_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_369_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_369_Society {
    __kind: 'Society'
    value: SocietyEvent
}

export interface Type_369_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_369_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_369_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_369_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_369_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_369_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_369_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}
