...
export const Retriable: sts.Type<Retriable> = sts.closedEnum(() => {
    return  {
        Never: sts.unit(),
        WithRetries: sts.number(),
    }
})

export type CollatorId = Bytes

export type IncomingParachain = IncomingParachain_Deploy | IncomingParachain_Fixed | IncomingParachain_Unset
...
export const IncomingParachain: sts.Type<IncomingParachain> = sts.closedEnum(() => {
    return  {
...
export const IncomingParachainFixed: sts.Type<IncomingParachainFixed> = sts.struct(() => {
    return  {
        codeHash: Hash,
        codeSize: sts.number(),
        initialHeadData: HeadData,
...
export const IncomingParachainDeploy: sts.Type<IncomingParachainDeploy> = sts.struct(() => {
    return  {
        code: ValidationCode,
        initialHeadData: HeadData,
    }
...
export type Bidder = Bidder_Existing | Bidder_New
...
export const Bidder: sts.Type<Bidder> = sts.closedEnum(() => {
    return  {
        Existing: ParaId,
        New: NewBidder,
    }
...
export const BlockAttestations: sts.Type<BlockAttestations> = sts.struct(() => {
    return  {
        receipt: CandidateReceipt,
        valid: sts.array(() => AccountId),
        invalid: sts.array(() => AccountId),
    }
})
...
export interface IncludedBlocks {
    ...
    randomSeed: H256
    activeParachains: ParaId[]
    paraBlocks: Hash[]
}

export type H256 = Bytes

export const IncludedBlocks: sts.Type<IncludedBlocks> = sts.struct(() => {
    return  {
        actualNumber: BlockNumber,
        session: SessionIndex,
        randomSeed: H256,
        activeParachains: sts.array(() => ParaId),
        paraBlocks: sts.array(() => Hash),
    }
})
...
export type SudoCall = SudoCall_set_key | SudoCall_sudo | SudoCall_sudo_as
...
export type DemocracyCall = DemocracyCall_cancel_queued | DemocracyCall_cancel_referendum | DemocracyCall_delegate | DemocracyCall_emergency_cancel | DemocracyCall_external_propose | DemocracyCall_external_propose_default | DemocracyCall_external_propose_majority | DemocracyCall_fast_track | DemocracyCall_propose | DemocracyCall_proxy_vote | DemocracyCall_remove_proxy | DemocracyCall_resign_proxy | DemocracyCall_second | DemocracyCall_set_proxy | DemocracyCall_undelegate | DemocracyCall_veto_external | DemocracyCall_vote
...
export const EraPoints: sts.Type<EraPoints> = sts.struct(() => {
    return  {
        total: Points,
        individual: sts.array(() => Points),
    }
})

export const Points = sts.number()

export type SessionIndex = number

export type MomentOf = bigint

export const MomentOf = sts.bigint()
...
export type MaybeVrf = (VrfData | undefined)

export type VrfData = Bytes

export const MaybeVrf = sts.option(() => VrfData)

export const VrfData = sts.bytes()
...
export type Type_212 = Type_212_Balances | Type_212_Claims | Type_212_Council | Type_212_Democracy | Type_212_ElectionsPhragmen | Type_212_Grandpa | Type_212_ImOnline | Type_212_Indices | Type_212_Nicks | Type_212_Offences | Type_212_Registrar | Type_212_Session | Type_212_Slots | Type_212_Staking | Type_212_Sudo | Type_212_System | Type_212_TechnicalCommittee | Type_212_TechnicalMembership | Type_212_Treasury

export interface Type_212_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_212_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_212_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_212_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_212_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_212_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_212_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_212_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_212_Nicks {
    __kind: 'Nicks'
    value: NicksEvent
}

export interface Type_212_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_212_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_212_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_212_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_212_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_212_Sudo {
    __kind: 'Sudo'
    value: SudoEvent
}

export interface Type_212_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_212_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_212_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_212_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export type TreasuryEvent = TreasuryEvent_Awarded | TreasuryEvent_Burnt | TreasuryEvent_Deposit | TreasuryEvent_Proposed | TreasuryEvent_Rollover | TreasuryEvent_Spending
...
export type TechnicalMembershipEvent = TechnicalMembershipEvent_Dummy | TechnicalMembershipEvent_MemberAdded | TechnicalMembershipEvent_MemberRemoved | TechnicalMembershipEvent_MembersReset | TechnicalMembershipEvent_MembersSwapped
...
export type SystemEvent = SystemEvent_ExtrinsicFailed | SystemEvent_ExtrinsicSuccess
...
export type NicksEvent = NicksEvent_NameChanged | NicksEvent_NameCleared | NicksEvent_NameForced | NicksEvent_NameKilled | NicksEvent_NameSet
...
export type DemocracyEvent = DemocracyEvent_Cancelled | DemocracyEvent_Delegated | DemocracyEvent_Executed | DemocracyEvent_ExternalTabled | DemocracyEvent_NotPassed | DemocracyEvent_Passed | DemocracyEvent_Proposed | DemocracyEvent_Started | DemocracyEvent_Tabled | DemocracyEvent_Undelegated | DemocracyEvent_Vetoed
...
export const NicksEvent: sts.Type<NicksEvent> = sts.closedEnum(() => {
    return  {
        NameChanged: AccountId,
        NameCleared: sts.tuple(() => [AccountId, Balance]),
        NameForced: AccountId,
        NameKilled: sts.tuple(() => [AccountId, Balance]),
        NameSet: AccountId,
    }
})
