...
export const eraPayout =  {
    ...
    v1062: new EventType(
        'Staking.EraPayout',
        sts.tuple([v1062.EraIndex, v1062.Balance, v1062.Balance])
    ),
}
...
export const kicked =  {
    ...
    v2028: new EventType(
        'Staking.Kicked',
        sts.tuple([v2028.AccountId, v2028.AccountId])
    ),
    /**
...
export const slashReported =  {
    ...
    v9350: new EventType(
        ...
        sts.struct({
            validator: v9350.AccountId32,
            fraction: v9350.Perbill,
            slashEra: sts.number(),
        })
    ),
}
