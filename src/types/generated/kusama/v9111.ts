...
export const Type_580: sts.Type<Type_580> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export type Type_578 = Type_578_Response | Type_578_Xcm
...
export type Type_576 = Type_576_Member | Type_576_Members | Type_576__Phantom
...
export type Type_575 = Type_575_Member | Type_575_Members | Type_575__Phantom
...
export const Type_576: sts.Type<Type_576> = sts.closedEnum(() => {
    return  {
        Member: AccountId32,
...
export type Event = Event_Auctions | Event_BagsList | Event_Balances | Event_Bounties | Event_Claims | Event_Council | Event_Crowdloan | Event_Democracy | Event_ElectionProviderMultiPhase | Event_Gilt | Event_Grandpa | Event_Hrmp | Event_Identity | Event_ImOnline | Event_Indices | Event_Multisig | Event_Offences | Event_ParaInclusion | Event_Paras | Event_PhragmenElection | Event_Proxy | Event_Recovery | Event_Registrar | Event_Scheduler | Event_Session | Event_Slots | Event_Society | Event_Staking | Event_System | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tips | Event_Treasury | Event_Ump | Event_Utility | Event_Vesting | Event_XcmPallet
...
export interface GiltEvent_BidPlaced {
    __kind: 'BidPlaced'
    value: [AccountId32, bigint, number]
}
...
export interface GiltEvent_GiltIssued {
    __kind: 'GiltIssued'
    value: [number, number, AccountId32, bigint]
}
...
export interface GiltEvent_GiltThawed {
    __kind: 'GiltThawed'
    value: [number, AccountId32, bigint, bigint]
}
...
export const GiltEvent: sts.Type<GiltEvent> = sts.closedEnum(() => {
    return  {
        BidPlaced: sts.tuple(() => [AccountId32, sts.bigint(), sts.number()]),
        BidRetracted: sts.tuple(() => [AccountId32, sts.bigint(), sts.number()]),
        GiltIssued: sts.tuple(() => [sts.number(), sts.number(), AccountId32, sts.bigint()]),
        GiltThawed: sts.tuple(() => [sts.number(), AccountId32, sts.bigint(), sts.bigint()]),
    }
})
