...
export const SignedSubmissionOf: sts.Type<SignedSubmissionOf> = sts.struct(() => {
    return  {
        who: AccountId,
        deposit: Balance,
        solution: RawSolution,
...
export type Type_500 = Type_500_Auctions | Type_500_Balances | Type_500_Bounties | Type_500_Claims | Type_500_Council | Type_500_Crowdloan | Type_500_Democracy | Type_500_ElectionProviderMultiPhase | Type_500_Gilt | Type_500_Grandpa | Type_500_Identity | Type_500_ImOnline | Type_500_Indices | Type_500_Multisig | Type_500_Offences | Type_500_Paras | Type_500_ParasHrmp | Type_500_ParasInclusion | Type_500_ParasUmp | Type_500_PhragmenElection | Type_500_Proxy | Type_500_Recovery | Type_500_Registrar | Type_500_Scheduler | Type_500_Session | Type_500_Slots | Type_500_Society | Type_500_Staking | Type_500_System | Type_500_TechnicalCommittee | Type_500_TechnicalMembership | Type_500_Tips | Type_500_Treasury | Type_500_Utility | Type_500_Vesting | Type_500_XcmPallet

export interface Type_500_Auctions {
    __kind: 'Auctions'
    value: AuctionsEvent
}

export interface Type_500_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_500_Bounties {
    __kind: 'Bounties'
    value: BountiesEvent
}

export interface Type_500_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_500_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_500_Crowdloan {
    __kind: 'Crowdloan'
    value: CrowdloanEvent
}

export interface Type_500_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_500_ElectionProviderMultiPhase {
    __kind: 'ElectionProviderMultiPhase'
    value: ElectionProviderMultiPhaseEvent
}

export interface Type_500_Gilt {
    __kind: 'Gilt'
    value: GiltEvent
}

export interface Type_500_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_500_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_500_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_500_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_500_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_500_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_500_Paras {
    __kind: 'Paras'
    value: ParasEvent
}

export interface Type_500_ParasHrmp {
    __kind: 'ParasHrmp'
    value: ParasHrmpEvent
}

export interface Type_500_ParasInclusion {
    __kind: 'ParasInclusion'
    value: ParasInclusionEvent
}

export interface Type_500_ParasUmp {
    __kind: 'ParasUmp'
    value: ParasUmpEvent
}

export interface Type_500_PhragmenElection {
    __kind: 'PhragmenElection'
    value: PhragmenElectionEvent
}

export interface Type_500_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_500_Recovery {
    __kind: 'Recovery'
    value: RecoveryEvent
}

export interface Type_500_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_500_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_500_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_500_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_500_Society {
    __kind: 'Society'
    value: SocietyEvent
}

export interface Type_500_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_500_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_500_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_500_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_500_Tips {
    __kind: 'Tips'
    value: TipsEvent
}

export interface Type_500_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_500_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_500_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}

export interface Type_500_XcmPallet {
    __kind: 'XcmPallet'
...
export type StakingEvent = StakingEvent_Bonded | StakingEvent_EraPayout | StakingEvent_Kicked | StakingEvent_OldSlashingReportDiscarded | StakingEvent_Reward | StakingEvent_Slash | StakingEvent_StakingElection | StakingEvent_StakingElectionFailed | StakingEvent_Unbonded | StakingEvent_Withdrawn
