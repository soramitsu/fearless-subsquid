...
export const ReceiptRecord: sts.Type<ReceiptRecord> = sts.struct(() => {
    return  {
        proportion: Perquintill,
        owner: sts.option(() => sts.tuple(() => [AccountId32, sts.bigint()])),
        expiry: sts.number(),
    }
})
...
export const SummaryRecord: sts.Type<SummaryRecord> = sts.struct(() => {
    return  {
        ...
        receiptsOnHold: sts.bigint(),
    }
})

export type Type_649 = Type_649_Approved | Type_649_Cancelled | Type_649_Killed | Type_649_Ongoing | Type_649_Rejected | Type_649_TimedOut
...
export const Type_649: sts.Type<Type_649> = sts.closedEnum(() => {
    return  {
...
export const Type_650: sts.Type<Type_650> = sts.struct(() => {
    return  {
        track: sts.number(),
        origin: OriginCaller,
        proposal: Bounded,
...
export type Type_626 = Type_626_Approved | Type_626_Cancelled | Type_626_Killed | Type_626_Ongoing | Type_626_Rejected | Type_626_TimedOut
...
export const Type_626: sts.Type<Type_626> = sts.closedEnum(() => {
    return  {
        Approved: sts.tuple(() => [sts.number(), sts.option(() => Deposit), sts.option(() => Deposit)]),
        Cancelled: sts.tuple(() => [sts.number(), sts.option(() => Deposit), sts.option(() => Deposit)]),
        Killed: sts.number(),
...
export const Type_627: sts.Type<Type_627> = sts.struct(() => {
    return  {
        track: sts.number(),
        origin: OriginCaller,
        proposal: Bounded,
