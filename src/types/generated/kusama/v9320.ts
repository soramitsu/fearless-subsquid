...
export type Type_643 = Type_643_Approved | Type_643_Cancelled | Type_643_Killed | Type_643_Ongoing | Type_643_Rejected | Type_643_TimedOut
...
export const Type_643: sts.Type<Type_643> = sts.closedEnum(() => {
    return  {
...
export type Type_620 = Type_620_Approved | Type_620_Cancelled | Type_620_Killed | Type_620_Ongoing | Type_620_Rejected | Type_620_TimedOut
...
export const Type_620: sts.Type<Type_620> = sts.closedEnum(() => {
    return  {
        Approved: sts.tuple(() => [sts.number(), Deposit, sts.option(() => Deposit)]),
        Cancelled: sts.tuple(() => [sts.number(), Deposit, sts.option(() => Deposit)]),
        Killed: sts.number(),
...
export const GiltEvent: sts.Type<GiltEvent> = sts.closedEnum(() => {
    return  {
        ...
        GiltIssued: sts.enumStruct({
            index: sts.number(),
            expiry: sts.number(),
            who: AccountId32,
            amount: sts.bigint(),
        }),
        GiltThawed: sts.enumStruct({
            index: sts.number(),
            who: AccountId32,
