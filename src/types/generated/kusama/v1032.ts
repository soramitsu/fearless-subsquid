...
export type Type_263 = Type_263_Balances | Type_263_Claims | Type_263_Council | Type_263_Democracy | Type_263_ElectionsPhragmen | Type_263_Grandpa | Type_263_Identity | Type_263_ImOnline | Type_263_Indices | Type_263_Nicks | Type_263_Offences | Type_263_Registrar | Type_263_Session | Type_263_Slots | Type_263_Staking | Type_263_System | Type_263_TechnicalCommittee | Type_263_TechnicalMembership | Type_263_Treasury | Type_263_Utility

export interface Type_263_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_263_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_263_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_263_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_263_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_263_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_263_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_263_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_263_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_263_Nicks {
    __kind: 'Nicks'
    value: NicksEvent
}

export interface Type_263_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_263_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_263_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_263_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_263_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_263_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_263_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_263_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_263_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_263_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}
