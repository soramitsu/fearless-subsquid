...
export type SystemCall = SystemCall_fill_block | SystemCall_kill_prefix | SystemCall_kill_storage | SystemCall_migrate_accounts | SystemCall_remark | SystemCall_set_changes_trie_config | SystemCall_set_code | SystemCall_set_code_without_checks | SystemCall_set_heap_pages | SystemCall_set_storage | SystemCall_suicide
...
export const SystemCall: sts.Type<SystemCall> = sts.closedEnum(() => {
    return  {
        ...
        migrate_accounts: sts.enumStruct({
