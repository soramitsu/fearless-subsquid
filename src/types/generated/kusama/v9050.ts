...
export type Type_501 = Type_501_Auctions | Type_501_Balances | Type_501_Bounties | Type_501_Claims | Type_501_Council | Type_501_Crowdloan | Type_501_Democracy | Type_501_ElectionProviderMultiPhase | Type_501_Gilt | Type_501_Grandpa | Type_501_Identity | Type_501_ImOnline | Type_501_Indices | Type_501_Multisig | Type_501_Offences | Type_501_Paras | Type_501_ParasHrmp | Type_501_ParasInclusion | Type_501_ParasUmp | Type_501_PhragmenElection | Type_501_Proxy | Type_501_Recovery | Type_501_Registrar | Type_501_Scheduler | Type_501_Session | Type_501_Slots | Type_501_Society | Type_501_Staking | Type_501_System | Type_501_TechnicalCommittee | Type_501_TechnicalMembership | Type_501_Tips | Type_501_Treasury | Type_501_Utility | Type_501_Vesting | Type_501_XcmPallet

export interface Type_501_Auctions {
    __kind: 'Auctions'
    value: AuctionsEvent
}

export interface Type_501_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_501_Bounties {
    __kind: 'Bounties'
    value: BountiesEvent
}

export interface Type_501_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_501_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_501_Crowdloan {
    __kind: 'Crowdloan'
    value: CrowdloanEvent
}

export interface Type_501_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_501_ElectionProviderMultiPhase {
    __kind: 'ElectionProviderMultiPhase'
    value: ElectionProviderMultiPhaseEvent
}

export interface Type_501_Gilt {
    __kind: 'Gilt'
    value: GiltEvent
}

export interface Type_501_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_501_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_501_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_501_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_501_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_501_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_501_Paras {
    __kind: 'Paras'
    value: ParasEvent
}

export interface Type_501_ParasHrmp {
    __kind: 'ParasHrmp'
    value: ParasHrmpEvent
}

export interface Type_501_ParasInclusion {
    __kind: 'ParasInclusion'
    value: ParasInclusionEvent
}

export interface Type_501_ParasUmp {
    __kind: 'ParasUmp'
    value: ParasUmpEvent
}

export interface Type_501_PhragmenElection {
    __kind: 'PhragmenElection'
    value: PhragmenElectionEvent
}

export interface Type_501_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_501_Recovery {
    __kind: 'Recovery'
    value: RecoveryEvent
}

export interface Type_501_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_501_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_501_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_501_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_501_Society {
    __kind: 'Society'
    value: SocietyEvent
}

export interface Type_501_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_501_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_501_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_501_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_501_Tips {
    __kind: 'Tips'
    value: TipsEvent
}

export interface Type_501_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_501_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_501_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}

export interface Type_501_XcmPallet {
    __kind: 'XcmPallet'
