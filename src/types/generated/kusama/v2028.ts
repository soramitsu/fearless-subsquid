...
export const BountyStatusPendingPayout: sts.Type<BountyStatusPendingPayout> = sts.struct(() => {
    return  {
        curator: AccountId,
        beneficiary: AccountId,
        unlockAt: BlockNumber,
...
export const BountyStatusCuratorProposed: sts.Type<BountyStatusCuratorProposed> = sts.struct(() => {
    return  {
        curator: AccountId,
    }
})

export const BountyStatusActive: sts.Type<BountyStatusActive> = sts.struct(() => {
    return  {
        curator: AccountId,
        updateDue: BlockNumber,
    }
...
export type Type_345 = Type_345_Balances | Type_345_Bounties | Type_345_Claims | Type_345_Council | Type_345_Democracy | Type_345_ElectionsPhragmen | Type_345_Grandpa | Type_345_Identity | Type_345_ImOnline | Type_345_Indices | Type_345_Multisig | Type_345_Offences | Type_345_Proxy | Type_345_Recovery | Type_345_Scheduler | Type_345_Session | Type_345_Society | Type_345_Staking | Type_345_System | Type_345_TechnicalCommittee | Type_345_TechnicalMembership | Type_345_Tips | Type_345_Treasury | Type_345_Utility | Type_345_Vesting

export interface Type_345_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_345_Bounties {
    __kind: 'Bounties'
    value: BountiesEvent
}

export interface Type_345_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_345_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_345_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_345_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_345_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_345_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_345_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_345_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_345_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_345_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_345_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_345_Recovery {
    __kind: 'Recovery'
    value: RecoveryEvent
}

export interface Type_345_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_345_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_345_Society {
    __kind: 'Society'
    value: SocietyEvent
}

export interface Type_345_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_345_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_345_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_345_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_345_Tips {
    __kind: 'Tips'
    value: TipsEvent
}

export interface Type_345_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_345_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_345_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}
