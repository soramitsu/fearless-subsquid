...
export type IdentityCall = IdentityCall_add_registrar | IdentityCall_cancel_request | IdentityCall_clear_identity | IdentityCall_kill_identity | IdentityCall_provide_judgement | IdentityCall_request_judgement | IdentityCall_set_fee | IdentityCall_set_fields | IdentityCall_set_identity | IdentityCall_set_subs
...
export type Type_256 = Type_256_Balances | Type_256_Claims | Type_256_Council | Type_256_Democracy | Type_256_ElectionsPhragmen | Type_256_Grandpa | Type_256_Identity | Type_256_ImOnline | Type_256_Indices | Type_256_Nicks | Type_256_Offences | Type_256_Registrar | Type_256_Session | Type_256_Slots | Type_256_Staking | Type_256_System | Type_256_TechnicalCommittee | Type_256_TechnicalMembership | Type_256_Treasury

export interface Type_256_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_256_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_256_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_256_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_256_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_256_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_256_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_256_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_256_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_256_Nicks {
    __kind: 'Nicks'
    value: NicksEvent
}

export interface Type_256_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_256_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_256_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_256_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_256_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_256_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_256_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_256_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_256_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}
