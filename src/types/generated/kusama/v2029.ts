...
export interface RoundSnapshot {
    voters: [AccountId, VoteWeight, AccountId[]][]
    targets: AccountId[]
}

export type VoteWeight = bigint

export type AccountId = Bytes

export const RoundSnapshot: sts.Type<RoundSnapshot> = sts.struct(() => {
    return  {
        voters: sts.array(() => sts.tuple(() => [AccountId, VoteWeight, sts.array(() => AccountId)])),
        targets: sts.array(() => AccountId),
    }
})

export const VoteWeight = sts.bigint()
...
export type ElectionPhase = ElectionPhase_Emergency | ElectionPhase_Off | ElectionPhase_Signed | ElectionPhase_Unsigned
...
export interface ElectionPhase_Unsigned {
    __kind: 'Unsigned'
    value: [boolean, BlockNumber]
}

export const ElectionPhase: sts.Type<ElectionPhase> = sts.closedEnum(() => {
    return  {
        Emergency: sts.unit(),
        Off: sts.unit(),
        Signed: sts.unit(),
        Unsigned: sts.tuple(() => [sts.boolean(), BlockNumber]),
    }
})
...
export type Type_351 = Type_351_Balances | Type_351_Bounties | Type_351_Claims | Type_351_Council | Type_351_Democracy | Type_351_ElectionProviderMultiPhase | Type_351_ElectionsPhragmen | Type_351_Grandpa | Type_351_Identity | Type_351_ImOnline | Type_351_Indices | Type_351_Multisig | Type_351_Offences | Type_351_Proxy | Type_351_Recovery | Type_351_Scheduler | Type_351_Session | Type_351_Society | Type_351_Staking | Type_351_System | Type_351_TechnicalCommittee | Type_351_TechnicalMembership | Type_351_Tips | Type_351_Treasury | Type_351_Utility | Type_351_Vesting

export interface Type_351_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_351_Bounties {
    __kind: 'Bounties'
    value: BountiesEvent
}

export interface Type_351_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_351_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_351_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_351_ElectionProviderMultiPhase {
    __kind: 'ElectionProviderMultiPhase'
    value: ElectionProviderMultiPhaseEvent
}

export interface Type_351_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_351_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_351_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_351_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_351_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_351_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_351_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_351_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_351_Recovery {
    __kind: 'Recovery'
    value: RecoveryEvent
}

export interface Type_351_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_351_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_351_Society {
    __kind: 'Society'
    value: SocietyEvent
}

export interface Type_351_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_351_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_351_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_351_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_351_Tips {
    __kind: 'Tips'
    value: TipsEvent
}

export interface Type_351_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_351_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_351_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}
