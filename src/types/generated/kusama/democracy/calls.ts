...
export const emergencyCancel =  {
    ...
    v1020: new CallType(
        ...
        sts.struct({
            refIndex: v1020.ReferendumIndex,
        })
    ),
}
...
export const fastTrack =  {
    ...
    v1020: new CallType(
        ...
        sts.struct({
            proposalHash: v1020.Hash,
            votingPeriod: v1020.BlockNumber,
            delay: v1020.BlockNumber,
        })
    ),
}
...
export const enactProposal =  {
    ...
    v1058: new CallType(
        ...
        sts.struct({
            proposalHash: v1058.Hash,
            index: v1058.ReferendumIndex,
        })
    ),
}
...
export const blacklist =  {
    ...
    v2025: new CallType(
        'Democracy.blacklist',
        sts.struct({
            proposalHash: v2025.Hash,
            maybeRefIndex: sts.option(() => v2025.ReferendumIndex),
        })
    ),
}
