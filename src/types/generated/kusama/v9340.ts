...
export const ReceiptRecord: sts.Type<ReceiptRecord> = sts.struct(() => {
    return  {
        proportion: Perquintill,
        who: AccountId32,
        expiry: sts.number(),
...
export const SummaryRecord: sts.Type<SummaryRecord> = sts.struct(() => {
    return  {
        proportionOwed: Perquintill,
        index: sts.number(),
        thawed: Perquintill,
...
export const Type_723: sts.Type<Type_723> = sts.struct(() => {
    return  {
        amount: sts.bigint(),
        who: AccountId32,
    }
...
export const UnstakeRequest: sts.Type<UnstakeRequest> = sts.struct(() => {
    return  {
        stashes: sts.array(() => sts.tuple(() => [AccountId32, sts.bigint()])),
        checked: sts.array(() => sts.number()),
    }
})
...
export type Event = Event_Auctions | Event_Balances | Event_Bounties | Event_ChildBounties | Event_Claims | Event_ConvictionVoting | Event_Council | Event_Crowdloan | Event_Democracy | Event_ElectionProviderMultiPhase | Event_FastUnstake | Event_FellowshipCollective | Event_FellowshipReferenda | Event_Grandpa | Event_Hrmp | Event_Identity | Event_ImOnline | Event_Indices | Event_Multisig | Event_Nis | Event_NisCounterpartBalances | Event_NominationPools | Event_Offences | Event_ParaInclusion | Event_Paras | Event_ParasDisputes | Event_PhragmenElection | Event_Preimage | Event_Proxy | Event_Recovery | Event_Referenda | Event_Registrar | Event_Scheduler | Event_Session | Event_Slots | Event_Society | Event_Staking | Event_System | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tips | Event_TransactionPayment | Event_Treasury | Event_Ump | Event_Utility | Event_Vesting | Event_VoterList | Event_Whitelist | Event_XcmPallet
 ...
 */
export type NisCounterpartBalancesEvent = NisCounterpartBalancesEvent_BalanceSet | NisCounterpartBalancesEvent_Deposit | NisCounterpartBalancesEvent_DustLost | NisCounterpartBalancesEvent_Endowed | NisCounterpartBalancesEvent_ReserveRepatriated | NisCounterpartBalancesEvent_Reserved | NisCounterpartBalancesEvent_Slashed | NisCounterpartBalancesEvent_Transfer | NisCounterpartBalancesEvent_Unreserved | NisCounterpartBalancesEvent_Withdraw
...
export const XcmPalletEvent: sts.Type<XcmPalletEvent> = sts.closedEnum(() => {
    return  {
        AssetsClaimed: sts.tuple(() => [H256, V1MultiLocation, VersionedMultiAssets]),
