...
export const register =  {
    ...
    v9010: new CallType(
        ...
        sts.struct({
            id: v9010.ParaId,
            genesisHead: v9010.HeadData,
            validationCode: v9010.ValidationCode,
        })
    ),
}
