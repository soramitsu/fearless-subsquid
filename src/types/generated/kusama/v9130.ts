...
export const V1DisputeState: sts.Type<V1DisputeState> = sts.struct(() => {
    return  {
...
export const UtilityEvent: sts.Type<UtilityEvent> = sts.closedEnum(() => {
    return  {
        ...
        DispatchedAs: sts.result(() => sts.unit(), () => DispatchError),
