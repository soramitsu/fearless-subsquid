...
export const UpgradeRestriction: sts.Type<UpgradeRestriction> = sts.closedEnum(() => {
    return  {
        Present: sts.unit(),
    }
})
...
export type Type_498 = Type_498_Auctions | Type_498_Balances | Type_498_Bounties | Type_498_Claims | Type_498_Council | Type_498_Crowdloan | Type_498_Democracy | Type_498_ElectionProviderMultiPhase | Type_498_Gilt | Type_498_Grandpa | Type_498_Hrmp | Type_498_Identity | Type_498_ImOnline | Type_498_Indices | Type_498_Multisig | Type_498_Offences | Type_498_ParaInclusion | Type_498_Paras | Type_498_PhragmenElection | Type_498_Proxy | Type_498_Recovery | Type_498_Registrar | Type_498_Scheduler | Type_498_Session | Type_498_Slots | Type_498_Society | Type_498_Staking | Type_498_System | Type_498_TechnicalCommittee | Type_498_TechnicalMembership | Type_498_Tips | Type_498_Treasury | Type_498_Ump | Type_498_Utility | Type_498_Vesting | Type_498_XcmPallet

export interface Type_498_Auctions {
    __kind: 'Auctions'
    value: AuctionsEvent
}

export interface Type_498_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_498_Bounties {
    __kind: 'Bounties'
    value: BountiesEvent
}

export interface Type_498_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_498_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_498_Crowdloan {
    __kind: 'Crowdloan'
    value: CrowdloanEvent
}

export interface Type_498_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_498_ElectionProviderMultiPhase {
    __kind: 'ElectionProviderMultiPhase'
    value: ElectionProviderMultiPhaseEvent
}

export interface Type_498_Gilt {
    __kind: 'Gilt'
    value: GiltEvent
}

export interface Type_498_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_498_Hrmp {
    __kind: 'Hrmp'
    value: HrmpEvent
}

export interface Type_498_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_498_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_498_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_498_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_498_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_498_ParaInclusion {
    __kind: 'ParaInclusion'
    value: ParaInclusionEvent
}

export interface Type_498_Paras {
    __kind: 'Paras'
    value: ParasEvent
}

export interface Type_498_PhragmenElection {
    __kind: 'PhragmenElection'
    value: PhragmenElectionEvent
}

export interface Type_498_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_498_Recovery {
    __kind: 'Recovery'
    value: RecoveryEvent
}

export interface Type_498_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_498_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_498_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_498_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_498_Society {
    __kind: 'Society'
    value: SocietyEvent
}

export interface Type_498_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_498_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_498_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_498_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_498_Tips {
    __kind: 'Tips'
    value: TipsEvent
}

export interface Type_498_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_498_Ump {
    __kind: 'Ump'
    value: UmpEvent
}

export interface Type_498_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_498_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}

export interface Type_498_XcmPallet {
    __kind: 'XcmPallet'
...
export type UmpEvent = UmpEvent_ExecutedUpward | UmpEvent_InvalidFormat | UmpEvent_UnsupportedVersion | UmpEvent_UpwardMessagesReceived | UmpEvent_WeightExhausted
...
export type HrmpEvent = HrmpEvent_ChannelClosed | HrmpEvent_OpenChannelAccepted | HrmpEvent_OpenChannelRequested
...
export interface DemocracyEvent_Executed {
    __kind: 'Executed'
    value: [ReferendumIndex, DispatchResult]
}
...
export const DemocracyEvent: sts.Type<DemocracyEvent> = sts.closedEnum(() => {
    return  {
        ...
        Executed: sts.tuple(() => [ReferendumIndex, DispatchResult]),
