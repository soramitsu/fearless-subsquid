...
export const configuration =  {
     ...
     *  The configuration.
     */
    v7: new StorageType('DmpQueue.Configuration', 'Default', [], v7.ConfigData) as ConfigurationV7,
}
 ...
 *  The configuration.
 */
export interface ConfigurationV7  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): v7.ConfigData
    get(block: Block): Promise<(v7.ConfigData | undefined)>
}
...
export const counterForOverweight =  {
     ...
     */
    v7: new StorageType('DmpQueue.CounterForOverweight', 'Default', [], sts.number()) as CounterForOverweightV7,
}
