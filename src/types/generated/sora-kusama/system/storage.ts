...
export const blockWeight =  {
     ...
     *  The current weight for the block.
     */
    v7: new StorageType('System.BlockWeight', 'Default', [], v7.PerDispatchClass) as BlockWeightV7,
}
 ...
 *  The current weight for the block.
 */
export interface BlockWeightV7  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): v7.PerDispatchClass
    get(block: Block): Promise<(v7.PerDispatchClass | undefined)>
}
