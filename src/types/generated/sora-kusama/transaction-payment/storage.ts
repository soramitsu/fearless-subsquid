...
export const storageVersion =  {
    v1: new StorageType('TransactionPayment.StorageVersion', 'Default', [], v1.Type_144) as StorageVersionV1,
}

export interface StorageVersionV1  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): v1.Type_144
    get(block: Block): Promise<(v1.Type_144 | undefined)>
}
