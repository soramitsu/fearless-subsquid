...
export const proposals =  {
     ...
     */
    v7: new StorageType('Council.Proposals', 'Default', [], sts.array(() => v7.H256)) as ProposalsV7,
}
...
export const proposalOf =  {
     ...
     */
    v7: new StorageType('Council.ProposalOf', 'Optional', [v7.H256], v7.Call) as ProposalOfV7,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
...
export const voting =  {
     ...
     */
    v7: new StorageType('Council.Voting', 'Optional', [v7.H256], v7.Votes) as VotingV7,
}
...
export const proposalCount =  {
     ...
     *  Proposals so far.
     */
    v7: new StorageType('Council.ProposalCount', 'Default', [], sts.number()) as ProposalCountV7,
}
...
export const members =  {
     ...
     */
    v7: new StorageType('Council.Members', 'Default', [], sts.array(() => v7.AccountId32)) as MembersV7,
}
...
export const prime =  {
     ...
     */
    v7: new StorageType('Council.Prime', 'Optional', [], v7.AccountId32) as PrimeV7,
}
