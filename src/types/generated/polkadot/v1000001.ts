...
export type Type_454 = Type_454_ApplyExtrinsic | Type_454_Finalization | Type_454_Initialization

export interface Type_454_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_454_Finalization {
    __kind: 'Finalization'
}

export interface Type_454_Initialization {
