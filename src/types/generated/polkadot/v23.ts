...
export const ProxyAnnouncement: sts.Type<ProxyAnnouncement> = sts.struct(() => {
    return  {
        real: AccountId,
        callHash: Hash,
        height: BlockNumber,
...
export type Type_340 = Type_340_Balances | Type_340_Claims | Type_340_Council | Type_340_Democracy | Type_340_ElectionsPhragmen | Type_340_Grandpa | Type_340_Identity | Type_340_ImOnline | Type_340_Indices | Type_340_Multisig | Type_340_Offences | Type_340_Proxy | Type_340_Purchase | Type_340_Scheduler | Type_340_Session | Type_340_Staking | Type_340_System | Type_340_TechnicalCommittee | Type_340_TechnicalMembership | Type_340_Treasury | Type_340_Utility | Type_340_Vesting

export interface Type_340_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_340_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_340_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_340_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_340_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_340_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_340_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_340_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_340_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_340_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_340_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_340_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_340_Purchase {
    __kind: 'Purchase'
    value: PurchaseEvent
}

export interface Type_340_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_340_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_340_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_340_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_340_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_340_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_340_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_340_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_340_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}
