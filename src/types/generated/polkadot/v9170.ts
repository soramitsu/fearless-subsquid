...
export type Event = Event_Auctions | Event_BagsList | Event_Balances | Event_Bounties | Event_Claims | Event_Council | Event_Crowdloan | Event_Democracy | Event_ElectionProviderMultiPhase | Event_Grandpa | Event_Hrmp | Event_Identity | Event_ImOnline | Event_Indices | Event_Multisig | Event_Offences | Event_ParaInclusion | Event_Paras | Event_PhragmenElection | Event_Preimage | Event_Proxy | Event_Registrar | Event_Scheduler | Event_Session | Event_Slots | Event_Staking | Event_System | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tips | Event_Treasury | Event_Ump | Event_Utility | Event_Vesting | Event_XcmPallet
