...
export type Type_159 = Type_159_ApplyExtrinsic | Type_159_Finalization | Type_159_Initialization

export interface Type_159_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_159_Finalization {
    __kind: 'Finalization'
}

export interface Type_159_Initialization {
