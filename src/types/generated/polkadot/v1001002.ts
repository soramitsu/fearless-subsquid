...
export type RuntimeHoldReason = RuntimeHoldReason_Preimage
...
export type Event = Event_AssetRate | Event_Auctions | Event_Balances | Event_Bounties | Event_ChildBounties | Event_Claims | Event_ConvictionVoting | Event_Crowdloan | Event_ElectionProviderMultiPhase | Event_FastUnstake | Event_Grandpa | Event_Hrmp | Event_Identity | Event_ImOnline | Event_Indices | Event_MessageQueue | Event_Multisig | Event_NominationPools | Event_Offences | Event_ParaInclusion | Event_Paras | Event_ParasDisputes | Event_Preimage | Event_Proxy | Event_Referenda | Event_Registrar | Event_Scheduler | Event_Session | Event_Slots | Event_Staking | Event_System | Event_TransactionPayment | Event_Treasury | Event_Utility | Event_Vesting | Event_VoterList | Event_Whitelist | Event_XcmPallet
...
export type Type_469 = Type_469_ApplyExtrinsic | Type_469_Finalization | Type_469_Initialization

export interface Type_469_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_469_Finalization {
    __kind: 'Finalization'
}

export interface Type_469_Initialization {
...
export const NominationPoolsEvent: sts.Type<NominationPoolsEvent> = sts.closedEnum(() => {
    return  {
        ...
        MinBalanceDeficitAdjusted: sts.enumStruct({
            poolId: sts.number(),
            amount: sts.bigint(),
        }),
        MinBalanceExcessAdjusted: sts.enumStruct({
            poolId: sts.number(),
            amount: sts.bigint(),
        }),
 ...
 * The `Event` enum of this pallet
 */
export const AssetRateEvent: sts.Type<AssetRateEvent> = sts.closedEnum(() => {
    return  {
        AssetRateCreated: sts.enumStruct({
            assetKind: VersionedLocatableAsset,
            rate: FixedU128,
        }),
        AssetRateRemoved: sts.enumStruct({
            assetKind: VersionedLocatableAsset,
        }),
        AssetRateUpdated: sts.enumStruct({
            assetKind: VersionedLocatableAsset,
            old: FixedU128,
            new: FixedU128,
        }),
