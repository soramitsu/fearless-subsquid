...
export type Type_378 = Type_378_Balances | Type_378_Claims | Type_378_Council | Type_378_Democracy | Type_378_ElectionsPhragmen | Type_378_Grandpa | Type_378_Identity | Type_378_ImOnline | Type_378_Indices | Type_378_Multisig | Type_378_Offences | Type_378_Poll | Type_378_Proxy | Type_378_Purchase | Type_378_Registrar | Type_378_Scheduler | Type_378_Session | Type_378_Slots | Type_378_Staking | Type_378_System | Type_378_TechnicalCommittee | Type_378_TechnicalMembership | Type_378_Treasury | Type_378_Utility | Type_378_Vesting

export interface Type_378_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_378_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_378_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_378_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_378_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_378_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_378_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_378_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_378_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_378_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_378_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_378_Poll {
    __kind: 'Poll'
    value: PollEvent
}

export interface Type_378_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_378_Purchase {
    __kind: 'Purchase'
    value: PurchaseEvent
}

export interface Type_378_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_378_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_378_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_378_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_378_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_378_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_378_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_378_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_378_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_378_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_378_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}
