...
export interface OpenTip {
    reason: Hash
    who: AccountId
    finder?: (OpenTipFinderTo225 | undefined)
...
export type OpenTipFinderTo225 = [AccountId, Balance]

export const OpenTip: sts.Type<OpenTip> = sts.struct(() => {
    return  {
        reason: Hash,
        who: AccountId,
        finder: sts.option(() => OpenTipFinderTo225),
        closes: sts.option(() => BlockNumber),
        tips: sts.array(() => OpenTipTip),
    }
})

export const OpenTipTip = sts.tuple(() => [AccountId, Balance])

export const OpenTipFinderTo225 = sts.tuple(() => [AccountId, Balance])
...
export type Type_319 = Type_319_Balances | Type_319_Claims | Type_319_Council | Type_319_Democracy | Type_319_ElectionsPhragmen | Type_319_Grandpa | Type_319_ImOnline | Type_319_Indices | Type_319_Offences | Type_319_Registrar | Type_319_Scheduler | Type_319_Session | Type_319_Slots | Type_319_Staking | Type_319_Sudo | Type_319_System | Type_319_TechnicalCommittee | Type_319_TechnicalMembership | Type_319_Treasury | Type_319_Utility | Type_319_Vesting

export interface Type_319_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_319_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_319_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_319_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_319_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_319_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_319_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_319_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_319_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_319_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_319_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_319_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_319_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_319_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_319_Sudo {
    __kind: 'Sudo'
    value: SudoEvent
}

export interface Type_319_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_319_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_319_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_319_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_319_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_319_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}
...
export type UtilityEvent = UtilityEvent_BatchCompleted | UtilityEvent_BatchInterrupted | UtilityEvent_MultisigApproval | UtilityEvent_MultisigCancelled | UtilityEvent_MultisigExecuted | UtilityEvent_NewMultisig | UtilityEvent_Uncallable
