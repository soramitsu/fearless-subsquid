...
export type Type_340 = Type_340_Balances | Type_340_Claims | Type_340_Council | Type_340_Democracy | Type_340_DummyPurchase | Type_340_DummyRegistrar | Type_340_DummySlots | Type_340_ElectionsPhragmen | Type_340_Grandpa | Type_340_Identity | Type_340_ImOnline | Type_340_Indices | Type_340_Multisig | Type_340_Offences | Type_340_Proxy | Type_340_Scheduler | Type_340_Session | Type_340_Staking | Type_340_System | Type_340_TechnicalCommittee | Type_340_TechnicalMembership | Type_340_Treasury | Type_340_Utility | Type_340_Vesting
...
export interface Type_340_DummyPurchase {
    __kind: 'DummyPurchase'
    value: DummyPurchaseEvent
}

export interface Type_340_DummyRegistrar {
    __kind: 'DummyRegistrar'
    value: DummyRegistrarEvent
}

export interface Type_340_DummySlots {
    __kind: 'DummySlots'
...
export type DummyPurchaseEvent = DummyPurchaseEvent_Dummy

export interface DummyPurchaseEvent_Dummy {
    __kind: 'Dummy'
    value: AccountId
}
...
export const Type_340: sts.Type<Type_340> = sts.closedEnum(() => {
    return  {
        ...
        DummyPurchase: DummyPurchaseEvent,
        DummyRegistrar: DummyRegistrarEvent,
        DummySlots: DummySlotsEvent,
...
export const DummySlotsEvent: sts.Type<DummySlotsEvent> = sts.closedEnum(() => {
    return  {
        Dummy: AccountId,
    }
})

export const DummyRegistrarEvent: sts.Type<DummyRegistrarEvent> = sts.closedEnum(() => {
    return  {
        Dummy: AccountId,
    }
})

export const DummyPurchaseEvent: sts.Type<DummyPurchaseEvent> = sts.closedEnum(() => {
    return  {
        Dummy: AccountId,
    }
})
