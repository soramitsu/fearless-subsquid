...
export type Event = Event_Auctions | Event_Balances | Event_Bounties | Event_ChildBounties | Event_Claims | Event_ConvictionVoting | Event_Council | Event_Crowdloan | Event_Democracy | Event_ElectionProviderMultiPhase | Event_FastUnstake | Event_Grandpa | Event_Hrmp | Event_Identity | Event_ImOnline | Event_Indices | Event_MessageQueue | Event_Multisig | Event_NominationPools | Event_Offences | Event_ParaInclusion | Event_Paras | Event_ParasDisputes | Event_PhragmenElection | Event_Preimage | Event_Proxy | Event_Referenda | Event_Registrar | Event_Scheduler | Event_Session | Event_Slots | Event_Staking | Event_System | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tips | Event_TransactionPayment | Event_Treasury | Event_Utility | Event_Vesting | Event_VoterList | Event_Whitelist | Event_XcmPallet
...
export type Type_479 = Type_479_ApplyExtrinsic | Type_479_Finalization | Type_479_Initialization

export interface Type_479_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_479_Finalization {
    __kind: 'Finalization'
}

export interface Type_479_Initialization {
