...
export const AccountStatus: sts.Type<AccountStatus> = sts.struct(() => {
    return  {
        validity: AccountValidity,
        freeBalance: Balance,
        lockedBalance: Balance,
...
export type Type_380 = Type_380_Balances | Type_380_Claims | Type_380_Council | Type_380_Democracy | Type_380_ElectionsPhragmen | Type_380_Grandpa | Type_380_Identity | Type_380_ImOnline | Type_380_Indices | Type_380_Multisig | Type_380_Offences | Type_380_Poll | Type_380_Proxy | Type_380_Purchase | Type_380_Registrar | Type_380_Scheduler | Type_380_Session | Type_380_Slots | Type_380_Staking | Type_380_Sudo | Type_380_System | Type_380_TechnicalCommittee | Type_380_TechnicalMembership | Type_380_Treasury | Type_380_Utility | Type_380_Vesting

export interface Type_380_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_380_Claims {
    __kind: 'Claims'
    value: ClaimsEvent
}

export interface Type_380_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_380_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_380_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_380_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_380_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_380_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_380_Indices {
    __kind: 'Indices'
    value: IndicesEvent
}

export interface Type_380_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_380_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_380_Poll {
    __kind: 'Poll'
    value: PollEvent
}

export interface Type_380_Proxy {
    __kind: 'Proxy'
    value: ProxyEvent
}

export interface Type_380_Purchase {
    __kind: 'Purchase'
    value: PurchaseEvent
}

export interface Type_380_Registrar {
    __kind: 'Registrar'
    value: RegistrarEvent
}

export interface Type_380_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_380_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_380_Slots {
    __kind: 'Slots'
    value: SlotsEvent
}

export interface Type_380_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_380_Sudo {
    __kind: 'Sudo'
    value: SudoEvent
}

export interface Type_380_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_380_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_380_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_380_Treasury {
    __kind: 'Treasury'
    value: TreasuryEvent
}

export interface Type_380_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_380_Vesting {
    __kind: 'Vesting'
    value: VestingEvent
}
...
export type PurchaseEvent = PurchaseEvent_AccountCreated | PurchaseEvent_BalanceUpdated | PurchaseEvent_PaymentAccountSet | PurchaseEvent_PaymentComplete | PurchaseEvent_StatementUpdated | PurchaseEvent_UnlockBlockUpdated | PurchaseEvent_ValidityUpdated

/**
 *  A new account was created
 */
export interface PurchaseEvent_AccountCreated {
    __kind: 'AccountCreated'
    value: AccountId
}
 ...
 */
export interface PurchaseEvent_BalanceUpdated {
 ...
 */
export interface PurchaseEvent_PaymentAccountSet {
    __kind: 'PaymentAccountSet'
    value: AccountId
}
 ...
 */
export interface PurchaseEvent_PaymentComplete {
    __kind: 'PaymentComplete'
    value: [AccountId, Balance, Balance]
}
 ...
 */
export interface PurchaseEvent_StatementUpdated {
    __kind: 'StatementUpdated'
}

/**
 *  A new statement was set.
 */
export interface PurchaseEvent_UnlockBlockUpdated {
    __kind: 'UnlockBlockUpdated'
    value: BlockNumber
}
 ...
 */
export interface PurchaseEvent_ValidityUpdated {
    __kind: 'ValidityUpdated'
    value: [AccountId, AccountValidity]
}
...
export type PollEvent = PollEvent_Voted

export interface PollEvent_Voted {
    __kind: 'Voted'
    value: [AccountId, Balance, Approvals]
}
...
export const PurchaseEvent: sts.Type<PurchaseEvent> = sts.closedEnum(() => {
    return  {
        AccountCreated: AccountId,
        BalanceUpdated: sts.tuple(() => [AccountId, Balance, Balance]),
        PaymentAccountSet: AccountId,
        PaymentComplete: sts.tuple(() => [AccountId, Balance, Balance]),
        StatementUpdated: sts.unit(),
        UnlockBlockUpdated: BlockNumber,
        ValidityUpdated: sts.tuple(() => [AccountId, AccountValidity]),
    }
})
...
export const PollEvent: sts.Type<PollEvent> = sts.closedEnum(() => {
    return  {
        Voted: sts.tuple(() => [AccountId, Balance, Approvals]),
    }
})
