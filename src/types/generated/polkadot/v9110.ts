...
export interface V1SessionInfo {
    validators: Bytes[]
    discoveryKeys: Bytes[]
    assignmentKeys: V1Public[]
    validatorGroups: V0ValidatorIndex[][]
    nCores: number
...
export const V1SessionInfo: sts.Type<V1SessionInfo> = sts.struct(() => {
    return  {
        validators: sts.array(() => sts.bytes()),
        discoveryKeys: sts.array(() => sts.bytes()),
        assignmentKeys: sts.array(() => V1Public),
        validatorGroups: sts.array(() => sts.array(() => V0ValidatorIndex)),
        nCores: sts.number(),
...
export type V1UpgradeGoAhead = V1UpgradeGoAhead_Abort | V1UpgradeGoAhead_GoAhead

export interface V1UpgradeGoAhead_Abort {
    __kind: 'Abort'
}

export interface V1UpgradeGoAhead_GoAhead {
    __kind: 'GoAhead'
}

export const V1UpgradeGoAhead: sts.Type<V1UpgradeGoAhead> = sts.closedEnum(() => {
    return  {
        Abort: sts.unit(),
        GoAhead: sts.unit(),
    }
...
export const AssignmentKind: sts.Type<AssignmentKind> = sts.closedEnum(() => {
    return  {
        Parachain: sts.unit(),
        Parathread: sts.tuple(() => [V0Public, sts.number()]),
    }
})

export const V0Public = sts.bytes()

export type V1CoreOccupied = V1CoreOccupied_Parachain | V1CoreOccupied_Parathread

export interface V1CoreOccupied_Parachain {
    __kind: 'Parachain'
}

export interface V1CoreOccupied_Parathread {
    __kind: 'Parathread'
    value: V1ParathreadEntry
}

export interface V1ParathreadEntry {
    claim: V1ParathreadClaim
    retries: number
}

export type V1ParathreadClaim = [Id, V0Public]

export const V1CoreOccupied: sts.Type<V1CoreOccupied> = sts.closedEnum(() => {
    return  {
        Parachain: sts.unit(),
        Parathread: V1ParathreadEntry,
    }
})

export const V1ParathreadEntry: sts.Type<V1ParathreadEntry> = sts.struct(() => {
    return  {
        claim: V1ParathreadClaim,
        retries: sts.number(),
    }
...
export const V1ParathreadClaim = sts.tuple(() => [Id, V0Public])
...
export interface AvailabilityBitfieldRecord {
    bitfield: V1AvailabilityBitfield
    submittedAt: number
}
...
export const HostConfiguration: sts.Type<HostConfiguration> = sts.struct(() => {
    return  {
        ...
        umpServiceTotalWeight: sts.bigint(),
        ...
        neededApprovals: sts.number(),
        relayVrfModuloSamples: sts.number(),
        umpMaxIndividualWeight: sts.bigint(),
    }
})
...
export type Type_462 = Type_462_V0 | Type_462_V1

export interface Type_462_V0 {
    __kind: 'V0'
}

export interface Type_462_V1 {
    __kind: 'V1'
}
...
export type Type_442 = Type_442_V1

export interface Type_442_V1 {
    __kind: 'V1'
}
...
export type Type_407 = Type_407_V1_0_0Ancient | Type_407_V2_0_0 | Type_407_V3_0_0 | Type_407_V4_0_0 | Type_407_V5_0_0 | Type_407_V6_0_0 | Type_407_V7_0_0 | Type_407_V8_0_0

export interface Type_407_V1_0_0Ancient {
    __kind: 'V1_0_0Ancient'
}

export interface Type_407_V2_0_0 {
    __kind: 'V2_0_0'
}

export interface Type_407_V3_0_0 {
    __kind: 'V3_0_0'
}

export interface Type_407_V4_0_0 {
    __kind: 'V4_0_0'
}

export interface Type_407_V5_0_0 {
    __kind: 'V5_0_0'
}

export interface Type_407_V6_0_0 {
    __kind: 'V6_0_0'
}

export interface Type_407_V7_0_0 {
    __kind: 'V7_0_0'
}

export interface Type_407_V8_0_0 {
    __kind: 'V8_0_0'
}
...
export type Type_385 = Type_385_V1Ancient | Type_385_V2

export interface Type_385_V1Ancient {
    __kind: 'V1Ancient'
}
...
export type Type_382 = Type_382_V1_0_0 | Type_382_V2_0_0

export interface Type_382_V1_0_0 {
    __kind: 'V1_0_0'
}

export interface Type_382_V2_0_0 {
    __kind: 'V2_0_0'
}
...
export type Releases = Releases_V1 | Releases_V2
...
export type OriginCaller = OriginCaller_Council | OriginCaller_ParachainsOrigin | OriginCaller_TechnicalCommittee | OriginCaller_Void | OriginCaller_system
...
export const ScheduledV2: sts.Type<ScheduledV2> = sts.struct(() => {
    return  {
