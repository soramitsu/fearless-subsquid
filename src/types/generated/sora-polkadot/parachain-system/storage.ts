...
export const validationData =  {
     ...
     *  in the trie.
     */
    v1: new StorageType('ParachainSystem.ValidationData', 'Optional', [], v1.V2PersistedValidationData) as ValidationDataV1,
}
...
export interface ValidationDataV1  {
    is(block: RuntimeCtx): boolean
    get(block: Block): Promise<(v1.V2PersistedValidationData | undefined)>
}
...
export const lastRelayChainBlockNumber =  {
     ...
     */
    v1: new StorageType('ParachainSystem.LastRelayChainBlockNumber', 'Default', [], sts.number()) as LastRelayChainBlockNumberV1,
}

/**
 *  The relay chain block number associated with the last parachain block.
 */
export interface LastRelayChainBlockNumberV1  {
    is(block: RuntimeCtx): boolean
...
export const upgradeRestrictionSignal =  {
     ...
     */
    v1: new StorageType('ParachainSystem.UpgradeRestrictionSignal', 'Default', [], sts.option(() => v1.V2UpgradeRestriction)) as UpgradeRestrictionSignalV1,
}
...
export interface UpgradeRestrictionSignalV1  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): (v1.V2UpgradeRestriction | undefined)
    get(block: Block): Promise<((v1.V2UpgradeRestriction | undefined) | undefined)>
}
...
export const relayStateProof =  {
     ...
     */
    v1: new StorageType('ParachainSystem.RelayStateProof', 'Optional', [], v1.StorageProof) as RelayStateProofV1,
}
 ...
 *  This data is also absent from the genesis.
 */
export interface RelayStateProofV1  {
    is(block: RuntimeCtx): boolean
    get(block: Block): Promise<(v1.StorageProof | undefined)>
}
...
export const hostConfiguration =  {
     ...
     *  This data is also absent from the genesis.
     */
    v1: new StorageType('ParachainSystem.HostConfiguration', 'Optional', [], v1.V2AbridgedHostConfiguration) as HostConfigurationV1,
}
...
export interface HostConfigurationV1  {
    is(block: RuntimeCtx): boolean
    get(block: Block): Promise<(v1.V2AbridgedHostConfiguration | undefined)>
}
...
export const reservedXcmpWeightOverride =  {
     ...
     */
    v1: new StorageType('ParachainSystem.ReservedXcmpWeightOverride', 'Optional', [], v1.Weight) as ReservedXcmpWeightOverrideV1,
}
...
export interface ReservedXcmpWeightOverrideV1  {
    is(block: RuntimeCtx): boolean
    get(block: Block): Promise<(v1.Weight | undefined)>
}
...
export const reservedDmpWeightOverride =  {
     ...
     *  overrides the amount set in the Config trait.
     */
    v1: new StorageType('ParachainSystem.ReservedDmpWeightOverride', 'Optional', [], v1.Weight) as ReservedDmpWeightOverrideV1,
}
...
export const customValidationHeadData =  {
     ...
     */
    v1: new StorageType('ParachainSystem.CustomValidationHeadData', 'Optional', [], sts.bytes()) as CustomValidationHeadDataV1,
}
 ...
 *  See [`Pallet::set_custom_validation_head_data`] for more information.
 */
export interface CustomValidationHeadDataV1  {
    is(block: RuntimeCtx): boolean
    get(block: Block): Promise<(Bytes | undefined)>
}
