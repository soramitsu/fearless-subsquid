...
export type Type_170 = Type_170_V1Ancient | Type_170_V2

export interface Type_170_V1Ancient {
    __kind: 'V1Ancient'
}

export interface Type_170_V2 {
    __kind: 'V2'
}
...
export const V2UpgradeRestriction: sts.Type<V2UpgradeRestriction> = sts.closedEnum(() => {
    return  {
        Present: sts.unit(),
    }
})
...
export type Event = Event_Balances | Event_BeefyLightClient | Event_CollatorSelection | Event_CumulusXcm | Event_DmpQueue | Event_LeafProvider | Event_ParachainSystem | Event_PolkadotXcm | Event_Session | Event_SubstrateBridgeInboundChannel | Event_SubstrateBridgeOutboundChannel | Event_SubstrateDispatch | Event_Sudo | Event_System | Event_TransactionPayment | Event_XCMApp | Event_XTokens | Event_XcmpQueue
 ...
 */
export type XCMAppEvent = XCMAppEvent_AssetAddedToChannel | XCMAppEvent_AssetMappingChanged | XCMAppEvent_MappingCreated | XCMAppEvent_MappingDeleted | XCMAppEvent_MultilocationtMappingChanged
...
export type SubstrateAppMessage = SubstrateAppMessage_FinalizeAssetRegistration | SubstrateAppMessage_Transfer

export interface SubstrateAppMessage_FinalizeAssetRegistration {
    __kind: 'FinalizeAssetRegistration'
    assetId: H256
    assetKind: AssetKind
}

export interface SubstrateAppMessage_Transfer {
    __kind: 'Transfer'
    assetId: H256
...
export const XCMAppEvent: sts.Type<XCMAppEvent> = sts.closedEnum(() => {
    return  {
        AssetAddedToChannel: SubstrateAppMessage,
        AssetMappingChanged: sts.tuple(() => [H256, V1MultiLocation]),
        MappingCreated: sts.tuple(() => [H256, V1MultiLocation]),
        MappingDeleted: sts.tuple(() => [H256, V1MultiLocation]),
        MultilocationtMappingChanged: sts.tuple(() => [H256, V1MultiLocation]),
    }
})
...
export interface SimplifiedMMRProof {
    merkleProofItems: H256[]
    merkleProofOrderBitField: bigint
}

export const SimplifiedMMRProof: sts.Type<SimplifiedMMRProof> = sts.struct(() => {
    return  {
        merkleProofItems: sts.array(() => H256),
        merkleProofOrderBitField: sts.bigint(),
    }
})
...
export const XCMAppCall: sts.Type<XCMAppCall> = sts.closedEnum(() => {
    return  {
        change_asset_mapping: sts.enumStruct({
            assetId: H256,
            newMultilocation: V1MultiLocation,
        }),
        change_multilocation_mapping: sts.enumStruct({
            multilocation: V1MultiLocation,
            newAssetId: H256,
        }),
        delete_mapping: sts.enumStruct({
            assetId: H256,
        }),
        fake_transfer: sts.enumStruct({
            accountId: AccountId32,
            assetId: H256,
            amount: sts.bigint(),
        }),
        register_asset: sts.enumStruct({
            assetId: H256,
            multiasset: V1AssetId,
            assetKind: AssetKind,
        }),
        register_mapping: sts.enumStruct({
            assetId: H256,
            multilocation: V1MultiLocation,
        }),
        test_xcm_transfer: sts.enumStruct({
            assetId: H256,
            sender: AccountId32,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XCMAppCall = XCMAppCall_change_asset_mapping | XCMAppCall_change_multilocation_mapping | XCMAppCall_delete_mapping | XCMAppCall_fake_transfer | XCMAppCall_register_asset | XCMAppCall_register_mapping | XCMAppCall_test_xcm_transfer | XCMAppCall_transfer
 ...
 */
export interface XCMAppCall_change_asset_mapping {
    __kind: 'change_asset_mapping'
    assetId: H256
    newMultilocation: V1MultiLocation
}
 ...
 */
export interface XCMAppCall_change_multilocation_mapping {
    __kind: 'change_multilocation_mapping'
    multilocation: V1MultiLocation
    newAssetId: H256
}
 ...
 * - `asset_id`: asset id in Sora Network,
 */
export interface XCMAppCall_delete_mapping {
    __kind: 'delete_mapping'
    assetId: H256
}

export interface XCMAppCall_fake_transfer {
    __kind: 'fake_transfer'
    accountId: AccountId32
    assetId: H256
    amount: bigint
}
 ...
 * - `multilocation`: XCM multilocation of an asset,
 */
export interface XCMAppCall_register_mapping {
    __kind: 'register_mapping'
    assetId: H256
    multilocation: V1MultiLocation
}

export interface XCMAppCall_test_xcm_transfer {
    __kind: 'test_xcm_transfer'
    assetId: H256
    sender: AccountId32
    recipient: VersionedMultiLocation
    amount: bigint
...
export type Type_225 = Type_225_V0 | Type_225_V1 | Type_225_V2

export interface Type_225_V0 {
    __kind: 'V0'
    value: Type_226
}

export interface Type_225_V1 {
    __kind: 'V1'
    value: Type_231
}
...
export type Type_237 = Type_237_BuyExecution | Type_237_ClaimAsset | Type_237_ClearError | Type_237_ClearOrigin | Type_237_DepositAsset | Type_237_DepositReserveAsset | Type_237_DescendOrigin | Type_237_ExchangeAsset | Type_237_HrmpChannelAccepted | Type_237_HrmpChannelClosing | Type_237_HrmpNewChannelOpenRequest | Type_237_InitiateReserveWithdraw | Type_237_InitiateTeleport | Type_237_QueryHolding | Type_237_QueryResponse | Type_237_ReceiveTeleportedAsset | Type_237_RefundSurplus | Type_237_ReportError | Type_237_ReserveAssetDeposited | Type_237_SetAppendix | Type_237_SetErrorHandler | Type_237_SubscribeVersion | Type_237_Transact | Type_237_TransferAsset | Type_237_TransferReserveAsset | Type_237_Trap | Type_237_UnsubscribeVersion | Type_237_WithdrawAsset

export interface Type_237_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_237_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_237_ClearError {
    __kind: 'ClearError'
}

export interface Type_237_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_237_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_237_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_237_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_237_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}
...
export interface Type_237_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_237_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_237_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_237_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_237_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_237_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_237[]
}

export interface Type_237_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_237[]
}
...
export interface Type_237_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export type Type_231 = Type_231_HrmpChannelAccepted | Type_231_HrmpChannelClosing | Type_231_HrmpNewChannelOpenRequest | Type_231_QueryResponse | Type_231_ReceiveTeleportedAsset | Type_231_RelayedFrom | Type_231_ReserveAssetDeposited | Type_231_SubscribeVersion | Type_231_Transact | Type_231_TransferAsset | Type_231_TransferReserveAsset | Type_231_UnsubscribeVersion | Type_231_WithdrawAsset
...
export type Type_233 = Type_233_BuyExecution | Type_233_DepositAsset | Type_233_DepositReserveAsset | Type_233_ExchangeAsset | Type_233_InitiateReserveWithdraw | Type_233_InitiateTeleport | Type_233_Noop | Type_233_QueryHolding
...
export type Type_226 = Type_226_HrmpChannelAccepted | Type_226_HrmpChannelClosing | Type_226_HrmpNewChannelOpenRequest | Type_226_QueryResponse | Type_226_RelayedFrom | Type_226_ReserveAssetDeposit | Type_226_TeleportAsset | Type_226_Transact | Type_226_TransferAsset | Type_226_TransferReserveAsset | Type_226_WithdrawAsset
...
export interface Type_226_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_228[]
}

export interface Type_226_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_228[]
}
...
export type Type_228 = Type_228_BuyExecution | Type_228_DepositAsset | Type_228_DepositReserveAsset | Type_228_ExchangeAsset | Type_228_InitiateReserveWithdraw | Type_228_InitiateTeleport | Type_228_Null | Type_228_QueryHolding
...
export interface Type_228_Null {
    __kind: 'Null'
}
...
export type Call = Call_Authorship | Call_Balances | Call_BeefyLightClient | Call_CollatorSelection | Call_DmpQueue | Call_ParachainSystem | Call_PolkadotXcm | Call_Session | Call_SubstrateBridgeInboundChannel | Call_Sudo | Call_System | Call_Timestamp | Call_XCMApp | Call_XcmpQueue
...
export const Type_237: sts.Type<Type_237> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_237),
        SetErrorHandler: sts.array(() => Type_237),
...
export const Type_233: sts.Type<Type_233> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_231),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export const SubstrateAppMessage: sts.Type<SubstrateAppMessage> = sts.closedEnum(() => {
    return  {
