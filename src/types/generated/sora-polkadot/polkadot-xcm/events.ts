...
export const sent =  {
    ...
    v10: new EventType(
        'PolkadotXcm.Sent',
        sts.tuple([v10.V3MultiLocation, v10.V3MultiLocation, sts.array(() => v10.V3Instruction)])
    ),
}
...
export const unexpectedResponse =  {
    ...
    v10: new EventType(
        'PolkadotXcm.UnexpectedResponse',
        sts.tuple([v10.V3MultiLocation, sts.bigint()])
    ),
}
...
export const responseReady =  {
    ...
    v10: new EventType(
        'PolkadotXcm.ResponseReady',
        sts.tuple([sts.bigint(), v10.V3Response])
    ),
}
...
export const notifyOverweight =  {
    ...
    v1: new EventType(
        ...
        sts.tuple([sts.bigint(), sts.number(), sts.number(), v1.Weight, v1.Weight])
    ),
}
...
export const invalidResponder =  {
    ...
    v10: new EventType(
        'PolkadotXcm.InvalidResponder',
        sts.tuple([v10.V3MultiLocation, sts.bigint(), sts.option(() => v10.V3MultiLocation)])
    ),
}
...
export const assetsTrapped =  {
    ...
    v10: new EventType(
        'PolkadotXcm.AssetsTrapped',
        sts.tuple([v10.H256, v10.V3MultiLocation, v10.VersionedMultiAssets])
    ),
}
...
export const versionChangeNotified =  {
    ...
    v10: new EventType(
        'PolkadotXcm.VersionChangeNotified',
        sts.tuple([v10.V3MultiLocation, sts.number(), sts.array(() => v10.V3MultiAsset)])
    ),
}
...
export const supportedVersionChanged =  {
    ...
    v10: new EventType(
        'PolkadotXcm.SupportedVersionChanged',
        sts.tuple([v10.V3MultiLocation, sts.number()])
    ),
}
...
export const notifyTargetSendFail =  {
    ...
    v10: new EventType(
        'PolkadotXcm.NotifyTargetSendFail',
        sts.tuple([v10.V3MultiLocation, sts.bigint(), v10.V3Error])
    ),
}
...
export const notifyTargetMigrationFail =  {
    ...
    v10: new EventType(
        'PolkadotXcm.NotifyTargetMigrationFail',
        sts.tuple([v10.VersionedMultiLocation, sts.bigint()])
    ),
}
...
export const invalidQuerier =  {
    ...
    v10: new EventType(
        ...
        sts.tuple([v10.V3MultiLocation, sts.bigint(), v10.V3MultiLocation, sts.option(() => v10.V3MultiLocation)])
    ),
}
...
export const versionNotifyStarted =  {
    ...
    v10: new EventType(
        ...
        sts.tuple([v10.V3MultiLocation, sts.array(() => v10.V3MultiAsset)])
    ),
}
