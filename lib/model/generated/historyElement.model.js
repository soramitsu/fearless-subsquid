...
let HistoryElement = class HistoryElement {
    constructor(props) {
...
], HistoryElement.prototype, "id", void 0);
__decorate([
    (0, typeorm_1.Column)("int4", { nullable: false }),
    __metadata("design:type", Number)
], HistoryElement.prototype, "blockNumber", void 0);
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ManyToOne)(() => staker_model_1.Staker, { nullable: true }),
    __metadata("design:type", Object)
], HistoryElement.prototype, "staker", void 0);
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ManyToOne)(() => delegator_model_1.Delegator, { nullable: true }),
    __metadata("design:type", Object)
], HistoryElement.prototype, "delegator", void 0);
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ManyToOne)(() => collator_model_1.Collator, { nullable: true }),
    __metadata("design:type", Object)
], HistoryElement.prototype, "collator", void 0);
__decorate([
    (0, typeorm_1.Column)("timestamp with time zone", { nullable: false }),
    __metadata("design:type", Date)
], HistoryElement.prototype, "timestamp", void 0);
__decorate([
    (0, typeorm_1.Column)("int4", { nullable: false }),
    __metadata("design:type", Number)
], HistoryElement.prototype, "type", void 0);
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.ManyToOne)(() => round_model_1.Round, { nullable: true }),
    __metadata("design:type", round_model_1.Round)
], HistoryElement.prototype, "round", void 0);
__decorate([
    (0, typeorm_1.Column)("numeric", { transformer: marshal.bigintTransformer, nullable: false }),
    __metadata("design:type", BigInt)
], HistoryElement.prototype, "amount", void 0);
HistoryElement = __decorate([
    (0, typeorm_1.Entity)(),
    __metadata("design:paramtypes", [Object])
], HistoryElement);
exports.HistoryElement = HistoryElement;
//# sourceMappingURL=historyElement.model.js.map