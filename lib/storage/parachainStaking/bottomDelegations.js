...
exports.getBottomDelegations = void 0;
const errors_1 = require("../../common/errors");
const tools_1 = require("../../common/tools");
const storage_1 = require("../../types/generated/storage");
async function getStorageData(ctx, accounts) {
    const storage = new storage_1.ParachainStakingBottomDelegationsStorage(ctx);
    if (!storage.isExists)
        return undefined;
    if (storage.isV1201) {
...
async function getBottomDelegations(ctx, accountOrAccounts) {
...
exports.getBottomDelegations = getBottomDelegations;
//# sourceMappingURL=bottomDelegations.js.map