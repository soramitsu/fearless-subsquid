...
exports.handleDelegationIncreased = void 0;
...
function getEventData(ctx) {
    const event = new events_1.ParachainStakingDelegationIncreasedEvent(ctx);
    if (event.isV1001) {
...
async function handleDelegationIncreased(ctx) {
...
exports.handleDelegationIncreased = handleDelegationIncreased;
//# sourceMappingURL=delegationIncreased.js.map