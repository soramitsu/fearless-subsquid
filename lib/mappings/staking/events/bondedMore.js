...
exports.handleBondedMore = void 0;
...
function getEventData(ctx) {
    const event = new events_1.ParachainStakingCandidateBondedMoreEvent(ctx);
    if (event.isV1001) {
...
async function handleBondedMore(ctx) {
    ...
    const collator = await ctx.store.get(model_1.Collator, { where: { id: accountId } });
...
exports.handleBondedMore = handleBondedMore;
//# sourceMappingURL=bondedMore.js.map