...
exports.handleDelegationRevoked = void 0;
...
function getEventData(ctx) {
    const event = new events_1.ParachainStakingDelegationRevokedEvent(ctx);
    if (event.isV1001) {
...
async function handleDelegationRevoked(ctx) {
...
exports.handleDelegationRevoked = handleDelegationRevoked;
//# sourceMappingURL=delegationRevoked.js.map